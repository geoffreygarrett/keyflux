...
// // }
// use crate::internal::FluxInternal;
// #[flux_define]
...
//                         FluxError::FluxFailed(
//                             "Failed to deserialize Supabase secrets JSON".to_string(),
//                         )
//                     })?;
//                     for secret in &secrets {
//                         info!(
//                             "Found secret - name: {}, value: {}",
...
//                     Err(FluxError::FluxFailed(
//                         "Failed to list Supabase secrets".to_string(),
//                     ))
//                 }
//             }
//             Err(e) => {
//                 error!("Failed to fetch existing secrets: {}", e);
//                 Err(FluxError::FluxFailed(format!(
...
//         // let input: SupabaseVariables = serde_json::from_value(raw_input).unwrap();
//
//         let filtered_keys: Vec<Key> = context.keys().iter()
//             .filter_map(|key| {
...
//             return Err(FluxError::FluxFailed(
//                 "No valid keys provided for upserting secrets.".to_string(),
//             ));
//         }
//
...
//                     Err(FluxError::FluxFailed(
//                         "Failed to set Supabase secrets".to_string(),
//                     ))
//                 }
//             }
//             Err(e) => {
