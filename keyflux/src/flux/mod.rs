...
//                 "{}",
//                 t!(
//                     "trace.creating_vercel_flux",
//                     config = format!("{:?}", config)
//                 )
//             );
//             let flux: VercelEnvironmentFlux =
//                 serde_json::from_value(config.clone()).map_err(|e| {
//                     ConfigError::InvalidConfig(format!(
//                         "{}",
//                         t!("error.parsing_vercel_flux", error = format!("{:?}", e))
//                     ))
//                 })?;
//             Ok(Box::new(flux))
//         }),
...
//             trace!(
//                 "{}",
//                 t!("trace.creating_file_flux", config = format!("{:?}", config))
//             );
//             let flux: FileFlux = serde_json::from_value(config.clone()).map_err(|e| {
//                 ConfigError::InvalidConfig(format!(
//                     "{}",
//                     t!("error.parsing_file_flux", error = format!("{:?}", e))
//                 ))
//             })?;
//             Ok(Box::new(flux))
//         }),
...
//                 "{}",
//                 t!(
//                     "trace.creating_supabase_flux",
//                     config = format!("{:?}", config)
//                 )
//             );
//             let flux: SupabaseFlux = serde_json::from_value(config.clone()).map_err(|e| {
//                 ConfigError::InvalidConfig(format!(
//                     "{}",
//                     t!("error.parsing_supabase_flux", error = format!("{:?}", e))
//                 ))
//             })?;
//             Ok(Box::new(flux))
//         }),
...
//                 "{}",
//                 t!(
//                     "trace.creating_supabase_vault_flux",
//                     config = format!("{:?}", config)
//                 )
//             );
//             let flux: SupabaseVaultFlux = serde_json::from_value(config.clone()).map_err(|e| {
//                 ConfigError::InvalidConfig(format!(
//                     "{}",
//                     t!(
//                         "error.parsing_supabase_vault_flux",
//                         error = format!("{:?}", e)
//                     )
//                 ))
//             })?;
...
//                 "{}",
//                 t!(
//                     "trace.creating_github_flux",
//                     config = format!("{:?}", config)
//                 )
//             );
//             let flux: GitHubFlux = serde_json::from_value(config.clone()).map_err(|e| {
//                 ConfigError::InvalidConfig(format!(
//                     "{}",
//                     t!("error.parsing_github_flux", error = format!("{:?}", e))
//                 ))
//             })?;
//             Ok(Box::new(flux))
//         }),
