...
lazy_static! {
    ...
    static ref CLI_ABOUT: String = t!("cli.about").to_string();
    static ref ENV_FILES_HELP: String = t!("cli.env_files.help").to_string();
    static ref CONFIG_FILE_HELP: String = t!("cli.config_file.help").to_string();
    static ref WATCH_HELP: String = t!("cli.watch.help").to_string();
    static ref LOG_LEVEL_HELP: String = t!("cli.log_level.help").to_string();
    static ref LOCALE_HELP: String = t!("cli.locale.help").to_string();
}
...
pub enum Commands {
    ...
    Convert {
        /// Optional path to the environment file, reads from stdin if not provided
        #[arg(long, short = 'f')]
        file: Option<PathBuf>,
