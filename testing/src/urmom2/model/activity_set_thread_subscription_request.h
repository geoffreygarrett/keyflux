/*
 * activity_set_thread_subscription_request.h
 *
 * 
 */

#ifndef _activity_set_thread_subscription_request_H_
#define _activity_set_thread_subscription_request_H_
...
typedef struct activity_set_thread_subscription_request_t activity_set_thread_subscription_request_t;




typedef struct activity_set_thread_subscription_request_t {
    int ignored; //boolean

} activity_set_thread_subscription_request_t;
...
#endif /* _activity_set_thread_subscription_request_H_ */
