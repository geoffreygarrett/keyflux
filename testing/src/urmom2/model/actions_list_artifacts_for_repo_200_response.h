/*
 * actions_list_artifacts_for_repo_200_response.h
 *
 * 
 */

#ifndef _actions_list_artifacts_for_repo_200_response_H_
#define _actions_list_artifacts_for_repo_200_response_H_
...
typedef struct actions_list_artifacts_for_repo_200_response_t actions_list_artifacts_for_repo_200_response_t;

#include "artifact.h"



typedef struct actions_list_artifacts_for_repo_200_response_t {
    int total_count; //numeric
    list_t *artifacts; //nonprimitive container

} actions_list_artifacts_for_repo_200_response_t;
...
#endif /* _actions_list_artifacts_for_repo_200_response_H_ */
