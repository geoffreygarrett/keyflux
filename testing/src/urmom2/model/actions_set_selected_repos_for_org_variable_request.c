...
#include <string.h>
#include <stdio.h>
#include "actions_set_selected_repos_for_org_variable_request.h"
...
actions_set_selected_repos_for_org_variable_request_t *actions_set_selected_repos_for_org_variable_request_create(
    ...
    actions_set_selected_repos_for_org_variable_request_t *actions_set_selected_repos_for_org_variable_request_local_var = malloc(sizeof(actions_set_selected_repos_for_org_variable_request_t));
    if (!actions_set_selected_repos_for_org_variable_request_local_var) {
        return NULL;
    }
    actions_set_selected_repos_for_org_variable_request_local_var->selected_repository_ids = selected_repository_ids;

    return actions_set_selected_repos_for_org_variable_request_local_var;
}
...
void actions_set_selected_repos_for_org_variable_request_free(actions_set_selected_repos_for_org_variable_request_t *actions_set_selected_repos_for_org_variable_request) {
    if(NULL == actions_set_selected_repos_for_org_variable_request){
        return ;
    }
    listEntry_t *listEntry;
    if (actions_set_selected_repos_for_org_variable_request->selected_repository_ids) {
        list_ForEach(listEntry, actions_set_selected_repos_for_org_variable_request->selected_repository_ids) {
            free(listEntry->data);
        }
        list_freeList(actions_set_selected_repos_for_org_variable_request->selected_repository_ids);
        actions_set_selected_repos_for_org_variable_request->selected_repository_ids = NULL;
    }
    free(actions_set_selected_repos_for_org_variable_request);
}
...
cJSON *actions_set_selected_repos_for_org_variable_request_convertToJSON(actions_set_selected_repos_for_org_variable_request_t *actions_set_selected_repos_for_org_variable_request) {
    ...
    // actions_set_selected_repos_for_org_variable_request->selected_repository_ids
    if (!actions_set_selected_repos_for_org_variable_request->selected_repository_ids) {
        goto fail;
    }
    ...
    list_ForEach(selected_repository_idsListEntry, actions_set_selected_repos_for_org_variable_request->selected_repository_ids) {
...
actions_set_selected_repos_for_org_variable_request_t *actions_set_selected_repos_for_org_variable_request_parseFromJSON(cJSON *actions_set_selected_repos_for_org_variable_requestJSON){
    ...
    actions_set_selected_repos_for_org_variable_request_t *actions_set_selected_repos_for_org_variable_request_local_var = NULL;

    // define the local list for actions_set_selected_repos_for_org_variable_request->selected_repository_ids
    list_t *selected_repository_idsList = NULL;

    // actions_set_selected_repos_for_org_variable_request->selected_repository_ids
    cJSON *selected_repository_ids = cJSON_GetObjectItemCaseSensitive(actions_set_selected_repos_for_org_variable_requestJSON, "selected_repository_ids");
    ...
    actions_set_selected_repos_for_org_variable_request_local_var = actions_set_selected_repos_for_org_variable_request_create (
