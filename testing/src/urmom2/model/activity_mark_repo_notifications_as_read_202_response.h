/*
 * activity_mark_repo_notifications_as_read_202_response.h
 *
 * 
 */

#ifndef _activity_mark_repo_notifications_as_read_202_response_H_
#define _activity_mark_repo_notifications_as_read_202_response_H_
...
typedef struct activity_mark_repo_notifications_as_read_202_response_t activity_mark_repo_notifications_as_read_202_response_t;




typedef struct activity_mark_repo_notifications_as_read_202_response_t {
    char *message; // string
    char *url; // string

} activity_mark_repo_notifications_as_read_202_response_t;
...
#endif /* _activity_mark_repo_notifications_as_read_202_response_H_ */
