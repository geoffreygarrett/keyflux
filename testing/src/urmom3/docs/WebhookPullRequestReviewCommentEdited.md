...
------------ | ------------- | ------------- | -------------
**action** | **String** |  | 
**changes** | [**crate::models::WebhooksChanges**](webhooks_changes.md) |  | 
...
**pull_request** | [**crate::models::WebhookPullRequestReviewCommentEditedPullRequest**](webhook_pull_request_review_comment_edited_pull_request.md) |  | 
