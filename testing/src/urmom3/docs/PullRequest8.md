...
**assignee** | Option<[**crate::models::User7**](User_7.md)> |  | 
**assignees** | [**Vec<crate::models::User7>**](User_7.md) |  | 
...
**milestone** | Option<[**crate::models::Milestone3**](Milestone_3.md)> |  | 
**node_id** | **String** |  | 
...
**requested_teams** | [**Vec<crate::models::Team3>**](Team_3.md) |  | 
...
**updated_at** | **String** |  | 
**url** | **String** |  | 
**user** | Option<[**crate::models::User8**](User_8.md)> |  | 
