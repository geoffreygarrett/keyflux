...
**keys_url** | **String** |  | 
**labels_url** | **String** |  | 
**language** | Option<[**serde_json::Value**](.md)> |  | 
**languages_url** | **String** |  | 
**license** | Option<[**serde_json::Value**](.md)> |  | 
**master_branch** | Option<**String**> |  | [optional]
**merges_url** | **String** |  | 
**milestones_url** | **String** |  | 
**mirror_url** | Option<[**serde_json::Value**](.md)> |  | 
**name** | **String** |  | 
**node_id** | **String** |  | 
...
**owner** | [**crate::models::WebhooksSponsorshipMaintainer**](webhooks_sponsorship_maintainer.md) |  | 
...
**tags_url** | **String** |  | 
**teams_url** | **String** |  | 
**topics** | [**Vec<serde_json::Value>**](serde_json::Value.md) |  | 
**trees_url** | **String** |  | 
**updated_at** | **String** |  | 
**url** | **String** |  | 
**visibility** | **String** |  | 
