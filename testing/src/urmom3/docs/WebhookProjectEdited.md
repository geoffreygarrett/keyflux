...
------------ | ------------- | ------------- | -------------
**action** | **String** |  | 
**changes** | Option<[**crate::models::WebhookProjectEditedChanges**](webhook_project_edited_changes.md)> |  | [optional]
...
**project** | [**crate::models::WebhooksProject**](webhooks_project.md) |  | 
