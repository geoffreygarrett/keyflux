...
> crate::models::SecretScanningAlert secret_scanning_slash_get_alert(owner, repo, alert_number)
...
[**crate::models::SecretScanningAlert**](secret-scanning-alert.md)
...
> Vec<crate::models::OrganizationSecretScanningAlert> secret_scanning_slash_list_alerts_for_enterprise(enterprise, state, secret_type, resolution, sort, direction, per_page, before, after, validity)
...
[**Vec<crate::models::OrganizationSecretScanningAlert>**](organization-secret-scanning-alert.md)
...
> Vec<crate::models::OrganizationSecretScanningAlert> secret_scanning_slash_list_alerts_for_org(org, state, secret_type, resolution, sort, direction, page, per_page, before, after, validity)
...
> Vec<crate::models::SecretScanningAlert> secret_scanning_slash_list_alerts_for_repo(owner, repo, state, secret_type, resolution, sort, direction, page, per_page, before, after, validity)
...
[**Vec<crate::models::SecretScanningAlert>**](secret-scanning-alert.md)
...
> Vec<crate::models::SecretScanningLocation> secret_scanning_slash_list_locations_for_alert(owner, repo, alert_number, page, per_page)
...
[**Vec<crate::models::SecretScanningLocation>**](secret-scanning-location.md)
...
> crate::models::SecretScanningAlert secret_scanning_slash_update_alert(owner, repo, alert_number, secret_scanning_update_alert_request)
