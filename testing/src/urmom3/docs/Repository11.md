...
**created_at** | Option<[**crate::models::OneOfLessThanIntegerCommaDateTimeGreaterThan**](oneOf<integer,DateTime>.md)> |  | 
...
**license** | Option<[**crate::models::License1**](License_1.md)> |  | 
...
**owner** | Option<[**crate::models::User5**](User_5.md)> |  | 
**permissions** | Option<[**crate::models::Repository11Permissions**](Repository_11_permissions.md)> |  | [optional]
**private** | **bool** | Whether the repository is private or public. | 
**public** | Option<**bool**> |  | [optional]
**pulls_url** | **String** |  | 
**pushed_at** | Option<[**crate::models::OneOfLessThanIntegerCommaDateTimeGreaterThan**](oneOf<integer,DateTime>.md)> |  | 
**releases_url** | **String** |  | 
