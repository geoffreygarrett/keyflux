...
------------ | ------------- | ------------- | -------------
**action** | **String** |  | 
**changes** | [**crate::models::WebhookDiscussionCommentEditedChanges**](webhook_discussion_comment_edited_changes.md) |  | 
**comment** | [**crate::models::WebhooksComment**](webhooks_comment.md) |  | 
