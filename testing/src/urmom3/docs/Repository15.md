...
**created_at** | [**crate::models::RepositoryCreatedAt**](Repository_created_at.md) |  | 
...
**merge_commit_message** | Option<**String**> | The default value for a merge commit message. | [optional]
**merge_commit_title** | Option<**String**> | The default value for a merge commit message title. | [optional]
**merges_url** | **String** |  | 
