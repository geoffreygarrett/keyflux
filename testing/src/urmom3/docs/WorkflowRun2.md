...
**head_repository** | [**crate::models::RepositoryLite**](Repository_Lite.md) |  | 
**head_sha** | **String** |  | 
**html_url** | **String** |  | 
**id** | **i32** |  | 
**jobs_url** | **String** |  | 
...
**pull_requests** | [**Vec<crate::models::WorkflowRun2PullRequestsInner>**](Workflow_Run_2_pull_requests_inner.md) |  | 
