...
------------ | ------------- | ------------- | -------------
**action** | **String** |  | 
**changes** | Option<[**crate::models::WebhookBranchProtectionRuleEditedChanges**](webhook_branch_protection_rule_edited_changes.md)> |  | [optional]
...
**rule** | [**crate::models::WebhooksRule**](webhooks_rule.md) |  | 
