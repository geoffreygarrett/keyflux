...
pub struct WebhooksMarketplacePurchase {
    ...
    #[serde(rename = "plan")]
    pub plan: Box<crate::models::WebhooksMarketplacePurchasePlan>,
    #[serde(rename = "unit_count")]
    pub unit_count: i32,
}

impl WebhooksMarketplacePurchase {
    pub fn new(account: crate::models::WebhooksMarketplacePurchaseAccount, billing_cycle: String, free_trial_ends_on: Option<String>, next_billing_date: Option<String>, on_free_trial: bool, plan: crate::models::WebhooksMarketplacePurchasePlan, unit_count: i32) -> WebhooksMarketplacePurchase {
