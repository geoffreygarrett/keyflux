...
impl WebhookMarketplacePurchasePurchased {
    pub fn new(action: Action, effective_date: String, marketplace_purchase: crate::models::WebhooksMarketplacePurchase, sender: crate::models::SimpleUserWebhooks) -> WebhookMarketplacePurchasePurchased {
