...
impl IssueComment {
    ...
    pub fn new(author_association: AuthorAssociation, body: String, created_at: String, html_url: String, id: i64, issue_url: String, node_id: String, performed_via_github_app: Option<crate::models::NullableIntegration>, reactions: crate::models::Reactions, updated_at: String, url: String, user: Option<crate::models::User1>) -> IssueComment {
        IssueComment {
            author_association,
            body,
            created_at,
