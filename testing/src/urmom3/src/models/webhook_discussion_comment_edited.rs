...
pub struct WebhookDiscussionCommentEdited {
    ...
    pub changes: Box<crate::models::WebhookDiscussionCommentEditedChanges>,
    #[serde(rename = "comment")]
    pub comment: Box<crate::models::WebhooksComment>,
...
impl WebhookDiscussionCommentEdited {
    pub fn new(action: Action, changes: crate::models::WebhookDiscussionCommentEditedChanges, comment: crate::models::WebhooksComment, discussion: crate::models::Discussion, repository: crate::models::RepositoryWebhooks, sender: crate::models::SimpleUserWebhooks) -> WebhookDiscussionCommentEdited {
