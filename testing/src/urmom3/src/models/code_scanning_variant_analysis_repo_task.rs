...
impl CodeScanningVariantAnalysisRepoTask {
    pub fn new(repository: crate::models::SimpleRepository, analysis_status: crate::models::CodeScanningVariantAnalysisStatus) -> CodeScanningVariantAnalysisRepoTask {
