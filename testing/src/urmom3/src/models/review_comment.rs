...
pub struct ReviewComment {
    ...
    #[serde(rename = "_links")]
    pub _links: Box<crate::models::ReviewCommentLinks>,
    ...
    #[serde(rename = "original_start_line", skip_serializing_if = "Option::is_none")]
    pub original_start_line: Option<i32>,
}

impl ReviewComment {
    /// Legacy Review Comment
    pub fn new(url: String, pull_request_review_id: Option<i64>, id: i64, node_id: String, diff_hunk: String, path: String, position: Option<i32>, original_position: i32, commit_id: String, original_commit_id: String, user: Option<crate::models::NullableSimpleUser>, body: String, created_at: String, updated_at: String, html_url: String, pull_request_url: String, author_association: crate::models::AuthorAssociation, _links: crate::models::ReviewCommentLinks) -> ReviewComment {
        ReviewComment {
            url,
