...
/// WebhooksIssue2 : The [issue](https://docs.github.com/rest/issues/issues#get-an-issue) itself.
...
impl WebhooksIssue2 {
    ...
    pub fn new(active_lock_reason: Option<ActiveLockReason>, assignees: Vec<crate::models::User>, author_association: AuthorAssociation, body: Option<String>, closed_at: Option<String>, comments: i32, comments_url: String, created_at: String, events_url: String, html_url: String, id: i64, labels_url: String, milestone: Option<crate::models::Milestone1>, node_id: String, number: i32, reactions: crate::models::Reactions, repository_url: String, title: String, updated_at: String, url: String, user: Option<crate::models::User1>) -> WebhooksIssue2 {
        WebhooksIssue2 {
            active_lock_reason,
            assignee: None,
            assignees,
