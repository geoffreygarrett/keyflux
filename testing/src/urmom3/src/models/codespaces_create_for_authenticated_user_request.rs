...
pub struct CodespacesCreateForAuthenticatedUserRequest {
    ...
    pub pull_request: Box<crate::models::CodespacesCreateForAuthenticatedUserRequestOneOf1PullRequest>,
}

impl CodespacesCreateForAuthenticatedUserRequest {
    pub fn new(repository_id: i32, pull_request: crate::models::CodespacesCreateForAuthenticatedUserRequestOneOf1PullRequest) -> CodespacesCreateForAuthenticatedUserRequest {
