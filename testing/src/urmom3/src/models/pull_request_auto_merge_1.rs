...
pub struct PullRequestAutoMerge1 {
    ...
    pub enabled_by: Option<Box<crate::models::User5>>,
...
impl PullRequestAutoMerge1 {
    ...
    pub fn new(commit_message: Option<String>, commit_title: Option<String>, enabled_by: Option<crate::models::User5>, merge_method: MergeMethod) -> PullRequestAutoMerge1 {
