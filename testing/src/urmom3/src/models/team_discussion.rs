...
impl TeamDiscussion {
    ...
    pub fn new(author: Option<crate::models::NullableSimpleUser>, body: String, body_html: String, body_version: String, comments_count: i32, comments_url: String, created_at: String, last_edited_at: Option<String>, html_url: String, node_id: String, number: i32, pinned: bool, private: bool, team_url: String, title: String, updated_at: String, url: String) -> TeamDiscussion {
        TeamDiscussion {
