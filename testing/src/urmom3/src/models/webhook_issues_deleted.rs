...
pub struct WebhookIssuesDeleted {
    ...
    #[serde(rename = "issue")]
    pub issue: Box<crate::models::Issue4>,
...
impl WebhookIssuesDeleted {
    pub fn new(action: Action, issue: crate::models::Issue4, repository: crate::models::RepositoryWebhooks, sender: crate::models::SimpleUserWebhooks) -> WebhookIssuesDeleted {
