...
impl CodeSearchResultItem {
    ...
    pub fn new(name: String, path: String, sha: String, url: String, git_url: String, html_url: String, repository: crate::models::MinimalRepository, score: f32) -> CodeSearchResultItem {
