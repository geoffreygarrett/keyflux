...
impl WebhookDiscussionUnpinned {
    pub fn new(action: Action, discussion: crate::models::Discussion, repository: crate::models::RepositoryWebhooks, sender: crate::models::SimpleUserWebhooks) -> WebhookDiscussionUnpinned {
