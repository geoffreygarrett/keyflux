...
impl WebhookPersonalAccessTokenRequestCreated {
    pub fn new(action: Action, personal_access_token_request: crate::models::PersonalAccessTokenRequest, organization: crate::models::OrganizationSimpleWebhooks, sender: crate::models::SimpleUserWebhooks) -> WebhookPersonalAccessTokenRequestCreated {
