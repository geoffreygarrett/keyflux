...
pub struct WebhookCodeScanningAlertReopenedByUser {
    ...
    pub action: Action,
    #[serde(rename = "alert")]
    pub alert: Box<crate::models::WebhookCodeScanningAlertReopenedByUserAlert>,
...
impl WebhookCodeScanningAlertReopenedByUser {
    pub fn new(action: Action, alert: crate::models::WebhookCodeScanningAlertReopenedByUserAlert, commit_oid: String, r#ref: String, repository: crate::models::RepositoryWebhooks, sender: crate::models::SimpleUserWebhooks) -> WebhookCodeScanningAlertReopenedByUser {
