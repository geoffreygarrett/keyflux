...
pub struct PullRequest11 {
    ...
    #[serde(rename = "base")]
    pub base: Box<crate::models::PullRequest11Base>,
    #[serde(rename = "body")]
...
impl PullRequest11 {
    pub fn new(_links: crate::models::WebhooksPullRequest5Links, active_lock_reason: Option<ActiveLockReason>, assignee: Option<crate::models::User3>, assignees: Vec<crate::models::User3>, author_association: AuthorAssociation, auto_merge: Option<crate::models::PullRequestAutoMerge>, base: crate::models::PullRequest11Base, body: Option<String>, closed_at: Option<String>, comments_url: String, commits_url: String, created_at: String, diff_url: String, draft: bool, head: crate::models::PullRequestHead, html_url: String, id: i32, issue_url: String, labels: Vec<crate::models::Label>, locked: bool, merge_commit_sha: Option<String>, merged_at: Option<String>, milestone: Option<crate::models::Milestone>, node_id: String, number: i32, patch_url: String, requested_reviewers: Vec<crate::models::PullRequestRequestedReviewersInner>, requested_teams: Vec<crate::models::Team>, review_comment_url: String, review_comments_url: String, state: State, statuses_url: String, title: String, updated_at: String, url: String, user: Option<crate::models::User2>) -> PullRequest11 {
        PullRequest11 {
