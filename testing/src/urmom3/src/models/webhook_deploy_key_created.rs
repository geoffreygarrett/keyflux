...
impl WebhookDeployKeyCreated {
    pub fn new(action: Action, key: crate::models::WebhooksDeployKey, repository: crate::models::RepositoryWebhooks, sender: crate::models::SimpleUserWebhooks) -> WebhookDeployKeyCreated {
