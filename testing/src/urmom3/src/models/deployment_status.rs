...
impl DeploymentStatus {
    ...
    pub fn new(url: String, id: i64, node_id: String, state: State, creator: Option<crate::models::NullableSimpleUser>, description: String, target_url: String, created_at: String, updated_at: String, deployment_url: String, repository_url: String) -> DeploymentStatus {
        DeploymentStatus {
            url,
            id,
            node_id,
