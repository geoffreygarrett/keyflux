...
impl WebhookTeamAddedToRepository {
    pub fn new(action: Action, organization: crate::models::OrganizationSimpleWebhooks, team: crate::models::WebhooksTeam1) -> WebhookTeamAddedToRepository {
