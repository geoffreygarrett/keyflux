...
impl WebhookCheckSuiteCompletedCheckSuite {
    ...
    pub fn new(after: Option<String>, app: crate::models::App2, before: Option<String>, check_runs_url: String, conclusion: Option<Conclusion>, created_at: String, head_branch: Option<String>, head_commit: crate::models::SimpleCommit, head_sha: String, id: i32, latest_check_runs_count: i32, node_id: String, pull_requests: Vec<crate::models::CheckRunPullRequest>, status: Option<Status>, updated_at: String, url: String) -> WebhookCheckSuiteCompletedCheckSuite {
