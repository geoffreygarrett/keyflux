...
impl WebhookMilestoneClosed {
    pub fn new(action: Action, milestone: crate::models::WebhooksMilestone, repository: crate::models::RepositoryWebhooks, sender: crate::models::SimpleUserWebhooks) -> WebhookMilestoneClosed {
