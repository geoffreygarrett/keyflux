...
pub struct WebhookIssuesTransferred {
    ...
    pub changes: Box<crate::models::WebhookIssuesTransferredChanges>,
...
impl WebhookIssuesTransferred {
    pub fn new(action: Action, changes: crate::models::WebhookIssuesTransferredChanges, issue: crate::models::WebhooksIssue2, repository: crate::models::RepositoryWebhooks, sender: crate::models::SimpleUserWebhooks) -> WebhookIssuesTransferred {
