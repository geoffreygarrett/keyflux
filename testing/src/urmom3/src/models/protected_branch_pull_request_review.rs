...
pub struct ProtectedBranchPullRequestReview {
    ...
    pub dismissal_restrictions: Option<Box<crate::models::ProtectedBranchPullRequestReviewDismissalRestrictions>>,
    #[serde(rename = "bypass_pull_request_allowances", skip_serializing_if = "Option::is_none")]
    pub bypass_pull_request_allowances: Option<Box<crate::models::ProtectedBranchPullRequestReviewBypassPullRequestAllowances>>,
