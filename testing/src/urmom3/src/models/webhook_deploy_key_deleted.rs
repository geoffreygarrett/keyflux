...
pub struct WebhookDeployKeyDeleted {
    ...
    #[serde(rename = "key")]
    pub key: Box<crate::models::WebhooksDeployKey>,
...
impl WebhookDeployKeyDeleted {
    pub fn new(action: Action, key: crate::models::WebhooksDeployKey, repository: crate::models::RepositoryWebhooks, sender: crate::models::SimpleUserWebhooks) -> WebhookDeployKeyDeleted {
