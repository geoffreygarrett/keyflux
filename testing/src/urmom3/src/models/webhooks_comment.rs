...
impl WebhooksComment {
    pub fn new(author_association: AuthorAssociation, body: String, child_comment_count: i32, created_at: String, discussion_id: i32, html_url: String, id: i32, node_id: String, parent_id: Option<i32>, reactions: crate::models::Reactions, repository_url: String, updated_at: String, user: Option<crate::models::User1>) -> WebhooksComment {
        WebhooksComment {
            author_association,
            body,
            child_comment_count,
