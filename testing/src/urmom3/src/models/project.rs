...
pub struct Project {
    ...
    pub creator: Option<Box<crate::models::NullableSimpleUser>>,
...
impl Project {
    ...
    pub fn new(owner_url: String, url: String, html_url: String, columns_url: String, id: i32, node_id: String, name: String, body: Option<String>, number: i32, state: String, creator: Option<crate::models::NullableSimpleUser>, created_at: String, updated_at: String) -> Project {
        Project {
            owner_url,
            url,
            html_url,
