...
pub struct RateLimitOverviewResources {
    #[serde(rename = "core")]
    pub core: Box<crate::models::RateLimit>,
    #[serde(rename = "graphql", skip_serializing_if = "Option::is_none")]
    pub graphql: Option<Box<crate::models::RateLimit>>,
    #[serde(rename = "search")]
    pub search: Box<crate::models::RateLimit>,
    #[serde(rename = "code_search", skip_serializing_if = "Option::is_none")]
    pub code_search: Option<Box<crate::models::RateLimit>>,
    #[serde(rename = "source_import", skip_serializing_if = "Option::is_none")]
    pub source_import: Option<Box<crate::models::RateLimit>>,
    #[serde(rename = "integration_manifest", skip_serializing_if = "Option::is_none")]
    pub integration_manifest: Option<Box<crate::models::RateLimit>>,
    #[serde(rename = "code_scanning_upload", skip_serializing_if = "Option::is_none")]
    pub code_scanning_upload: Option<Box<crate::models::RateLimit>>,
    #[serde(rename = "actions_runner_registration", skip_serializing_if = "Option::is_none")]
    pub actions_runner_registration: Option<Box<crate::models::RateLimit>>,
    #[serde(rename = "scim", skip_serializing_if = "Option::is_none")]
    pub scim: Option<Box<crate::models::RateLimit>>,
    #[serde(rename = "dependency_snapshots", skip_serializing_if = "Option::is_none")]
    pub dependency_snapshots: Option<Box<crate::models::RateLimit>>,
}

impl RateLimitOverviewResources {
    pub fn new(core: crate::models::RateLimit, search: crate::models::RateLimit) -> RateLimitOverviewResources {
