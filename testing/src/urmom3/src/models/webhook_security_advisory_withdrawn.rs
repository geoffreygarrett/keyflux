...
pub struct WebhookSecurityAdvisoryWithdrawn {
    ...
    pub security_advisory: Box<crate::models::WebhookSecurityAdvisoryWithdrawnSecurityAdvisory>,
    #[serde(rename = "sender", skip_serializing_if = "Option::is_none")]
    pub sender: Option<Box<crate::models::SimpleUserWebhooks>>,
}

impl WebhookSecurityAdvisoryWithdrawn {
    pub fn new(action: Action, security_advisory: crate::models::WebhookSecurityAdvisoryWithdrawnSecurityAdvisory) -> WebhookSecurityAdvisoryWithdrawn {
