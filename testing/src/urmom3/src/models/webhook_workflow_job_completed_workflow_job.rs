...
impl WebhookWorkflowJobCompletedWorkflowJob {
    pub fn new(check_run_url: String, completed_at: String, conclusion: Conclusion, created_at: String, head_sha: String, html_url: String, id: i32, labels: Vec<String>, name: String, node_id: String, run_attempt: i32, run_id: i32, run_url: String, runner_group_id: Option<f32>, runner_group_name: Option<String>, runner_id: Option<f32>, runner_name: Option<String>, started_at: String, status: String, head_branch: Option<String>, workflow_name: Option<String>, steps: Vec<serde_json::Value>, url: String) -> WebhookWorkflowJobCompletedWorkflowJob {
