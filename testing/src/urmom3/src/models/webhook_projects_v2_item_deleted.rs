...
impl WebhookProjectsV2ItemDeleted {
    pub fn new(action: Action, organization: crate::models::OrganizationSimpleWebhooks, projects_v2_item: crate::models::ProjectsV2Item, sender: crate::models::SimpleUserWebhooks) -> WebhookProjectsV2ItemDeleted {
