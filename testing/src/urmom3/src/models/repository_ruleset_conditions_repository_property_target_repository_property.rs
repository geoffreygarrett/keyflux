...
pub struct RepositoryRulesetConditionsRepositoryPropertyTargetRepositoryProperty {
    ...
    pub include: Option<Vec<crate::models::RepositoryRulesetConditionsRepositoryPropertySpec>>,
    /// The repository properties and values to exclude. The condition will not pass if any of these properties match.
    #[serde(rename = "exclude", skip_serializing_if = "Option::is_none")]
    pub exclude: Option<Vec<crate::models::RepositoryRulesetConditionsRepositoryPropertySpec>>,
}
