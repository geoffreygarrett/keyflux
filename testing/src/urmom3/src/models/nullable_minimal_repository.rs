...
pub struct NullableMinimalRepository {
    ...
    pub permissions: Option<Box<crate::models::MinimalRepositoryPermissions>>,
    ...
    pub license: Option<Box<crate::models::MinimalRepositoryLicense>>,
...
impl NullableMinimalRepository {
    /// Minimal Repository
