...
pub struct Discussion {
    ...
    pub answer_chosen_by: Option<Box<crate::models::User>>,
    #[serde(rename = "answer_html_url")]
    ...
    pub category: Box<crate::models::DiscussionCategory>,
...
impl Discussion {
    ...
    pub fn new(active_lock_reason: Option<String>, answer_chosen_at: Option<String>, answer_chosen_by: Option<crate::models::User>, answer_html_url: Option<String>, author_association: AuthorAssociation, body: String, category: crate::models::DiscussionCategory, comments: i32, created_at: String, html_url: String, id: i32, locked: bool, node_id: String, number: i32, repository_url: String, state: State, state_reason: Option<StateReason>, title: String, updated_at: String, user: Option<crate::models::User1>) -> Discussion {
        Discussion {
            active_lock_reason,
            answer_chosen_at,
