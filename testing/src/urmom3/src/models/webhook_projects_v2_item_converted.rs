...
pub struct WebhookProjectsV2ItemConverted {
    ...
    pub changes: Box<crate::models::WebhookProjectsV2ItemConvertedChanges>,
...
impl WebhookProjectsV2ItemConverted {
    pub fn new(action: Action, changes: crate::models::WebhookProjectsV2ItemConvertedChanges, organization: crate::models::OrganizationSimpleWebhooks, projects_v2_item: crate::models::ProjectsV2Item, sender: crate::models::SimpleUserWebhooks) -> WebhookProjectsV2ItemConverted {
