...
/// NullableRepositoryWebhooks : The repository on GitHub where the event occurred. Webhook payloads contain the `repository` property when the event occurs from activity in a repository.
...
pub struct NullableRepositoryWebhooks {
    ...
    pub template_repository: Option<Box<crate::models::RepositoryWebhooksTemplateRepository>>,
...
impl NullableRepositoryWebhooks {
