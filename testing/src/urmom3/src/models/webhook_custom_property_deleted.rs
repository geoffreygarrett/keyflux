...
pub struct WebhookCustomPropertyDeleted {
    ...
    pub definition: Box<crate::models::WebhookCustomPropertyDeletedDefinition>,
...
impl WebhookCustomPropertyDeleted {
    pub fn new(action: Action, definition: crate::models::WebhookCustomPropertyDeletedDefinition, organization: crate::models::OrganizationSimpleWebhooks) -> WebhookCustomPropertyDeleted {
