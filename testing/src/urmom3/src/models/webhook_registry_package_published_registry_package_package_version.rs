...
pub struct WebhookRegistryPackagePublishedRegistryPackagePackageVersion {
    ...
    pub author: Option<Box<crate::models::WebhookRegistryPackagePublishedRegistryPackageOwner>>,
    ...
    pub container_metadata: Option<Box<crate::models::WebhookRegistryPackagePublishedRegistryPackagePackageVersionContainerMetadata>>,
    ...
    pub npm_metadata: Option<Box<crate::models::WebhookRegistryPackagePublishedRegistryPackagePackageVersionNpmMetadata>>,
    #[serde(rename = "nuget_metadata", skip_serializing_if = "Option::is_none")]
    pub nuget_metadata: Option<Vec<crate::models::WebhookRegistryPackagePublishedRegistryPackagePackageVersionNugetMetadataInner>>,
    #[serde(rename = "package_files")]
    pub package_files: Vec<crate::models::WebhookRegistryPackagePublishedRegistryPackagePackageVersionPackageFilesInner>,
    ...
    pub release: Option<Box<crate::models::WebhookRegistryPackagePublishedRegistryPackagePackageVersionRelease>>,
