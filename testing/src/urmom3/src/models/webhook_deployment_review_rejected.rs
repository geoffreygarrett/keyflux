...
pub struct WebhookDeploymentReviewRejected {
    ...
    pub workflow_job_runs: Option<Vec<crate::models::WebhookDeploymentReviewRejectedWorkflowJobRunsInner>>,
    #[serde(rename = "workflow_run")]
    pub workflow_run: Option<Box<crate::models::DeploymentWorkflowRun2>>,
}

impl WebhookDeploymentReviewRejected {
    pub fn new(action: Action, organization: crate::models::OrganizationSimpleWebhooks, repository: crate::models::RepositoryWebhooks, sender: crate::models::SimpleUserWebhooks, since: String, workflow_run: Option<crate::models::DeploymentWorkflowRun2>) -> WebhookDeploymentReviewRejected {
