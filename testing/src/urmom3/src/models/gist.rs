...
impl Gist {
    /// Gist
    pub fn new(url: String, forks_url: String, commits_url: String, id: String, node_id: String, git_pull_url: String, git_push_url: String, html_url: String, files: ::std::collections::HashMap<String, crate::models::BaseGistFilesValue>, public: bool, created_at: String, updated_at: String, description: Option<String>, comments: i32, user: Option<crate::models::NullableSimpleUser>, comments_url: String) -> Gist {
        Gist {
            url,
            forks_url,
            commits_url,
