...
impl WebhooksProjectCard {
    pub fn new(archived: bool, column_id: i32, column_url: String, created_at: String, creator: Option<crate::models::User>, id: i32, node_id: String, note: Option<String>, project_url: String, updated_at: String, url: String) -> WebhooksProjectCard {
        WebhooksProjectCard {
            after_id: None,
            archived,
            column_id,
