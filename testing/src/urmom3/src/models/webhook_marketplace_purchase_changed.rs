...
pub struct WebhookMarketplacePurchaseChanged {
    ...
    pub previous_marketplace_purchase: Option<Box<crate::models::MarketplacePurchase>>,
...
impl WebhookMarketplacePurchaseChanged {
    pub fn new(action: Action, effective_date: String, marketplace_purchase: crate::models::WebhooksMarketplacePurchase, sender: crate::models::SimpleUserWebhooks) -> WebhookMarketplacePurchaseChanged {
