...
pub struct Webhook {
    ...
    pub last_response: Option<Box<crate::models::HookResponse>>,
...
impl Webhook {
    ...
    pub fn new(active: bool, config: crate::models::WebhookConfig, created_at: String, events: Vec<String>, id: i32, name: Name, r#type: String, updated_at: String) -> Webhook {
        Webhook {
            active,
            app_id: None,
