...
pub struct WebhookDiscussionCategoryChanged {
    ...
    pub changes: Box<crate::models::WebhookDiscussionCategoryChangedChanges>,
...
impl WebhookDiscussionCategoryChanged {
    pub fn new(action: Action, changes: crate::models::WebhookDiscussionCategoryChangedChanges, discussion: crate::models::Discussion, repository: crate::models::RepositoryWebhooks, sender: crate::models::SimpleUserWebhooks) -> WebhookDiscussionCategoryChanged {
