...
pub struct WebhookMarketplacePurchasePendingChange {
    ...
    pub previous_marketplace_purchase: Option<Box<crate::models::MarketplacePurchase1>>,
...
impl WebhookMarketplacePurchasePendingChange {
    pub fn new(action: Action, effective_date: String, marketplace_purchase: crate::models::WebhooksMarketplacePurchase, sender: crate::models::SimpleUserWebhooks) -> WebhookMarketplacePurchasePendingChange {
