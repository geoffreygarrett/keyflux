...
impl WebhookCodeScanningAlertReopenedAlert {
    ...
    pub fn new(created_at: String, dismissed_at: Option<String>, dismissed_by: Option<serde_json::Value>, dismissed_reason: Option<String>, html_url: String, number: i32, rule: crate::models::WebhookCodeScanningAlertClosedByUserAlertRule, state: State, tool: crate::models::WebhookCodeScanningAlertClosedByUserAlertTool, url: String) -> WebhookCodeScanningAlertReopenedAlert {
