...
pub struct CodeScanningVariantAnalysisSkippedRepoGroup {
    ...
    pub repositories: Vec<crate::models::CodeScanningVariantAnalysisRepository>,
}

impl CodeScanningVariantAnalysisSkippedRepoGroup {
    pub fn new(repository_count: i32, repositories: Vec<crate::models::CodeScanningVariantAnalysisRepository>) -> CodeScanningVariantAnalysisSkippedRepoGroup {
