...
pub struct ProtectedBranchRequiredStatusCheck {
    ...
    #[serde(rename = "checks")]
    pub checks: Vec<crate::models::ProtectedBranchRequiredStatusCheckChecksInner>,
...
impl ProtectedBranchRequiredStatusCheck {
    ...
    pub fn new(contexts: Vec<String>, checks: Vec<crate::models::ProtectedBranchRequiredStatusCheckChecksInner>) -> ProtectedBranchRequiredStatusCheck {
