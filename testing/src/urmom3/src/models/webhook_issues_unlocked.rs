...
pub struct WebhookIssuesUnlocked {
    ...
    #[serde(rename = "issue")]
    pub issue: Box<crate::models::Issue14>,
...
impl WebhookIssuesUnlocked {
    pub fn new(action: Action, issue: crate::models::Issue14, repository: crate::models::RepositoryWebhooks, sender: crate::models::SimpleUserWebhooks) -> WebhookIssuesUnlocked {
