...
pub struct WebhookCodeScanningAlertAppearedInBranch {
    ...
    pub action: Action,
    #[serde(rename = "alert")]
    pub alert: Box<crate::models::WebhookCodeScanningAlertAppearedInBranchAlert>,
...
impl WebhookCodeScanningAlertAppearedInBranch {
    pub fn new(action: Action, alert: crate::models::WebhookCodeScanningAlertAppearedInBranchAlert, commit_oid: String, r#ref: String, repository: crate::models::RepositoryWebhooks, sender: crate::models::SimpleUserWebhooks) -> WebhookCodeScanningAlertAppearedInBranch {
