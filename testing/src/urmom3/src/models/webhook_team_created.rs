...
impl WebhookTeamCreated {
    pub fn new(action: Action, organization: crate::models::OrganizationSimpleWebhooks, sender: crate::models::SimpleUserWebhooks, team: crate::models::WebhooksTeam1) -> WebhookTeamCreated {
        WebhookTeamCreated {
            action,
            enterprise: None,
            installation: None,
