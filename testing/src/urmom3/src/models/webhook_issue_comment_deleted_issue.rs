...
/// WebhookIssueCommentDeletedIssue : The [issue](https://docs.github.com/rest/issues/issues#get-an-issue) the comment belongs to.



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct WebhookIssueCommentDeletedIssue {
...
impl WebhookIssueCommentDeletedIssue {
    /// The [issue](https://docs.github.com/rest/issues/issues#get-an-issue) the comment belongs to.
    pub fn new(active_lock_reason: Option<String>, assignee: Option<crate::models::User3>, assignees: Vec<serde_json::Value>, author_association: String, body: Option<String>, closed_at: Option<String>, comments: i32, comments_url: String, created_at: String, events_url: String, html_url: String, id: i32, labels: Vec<crate::models::Label>, labels_url: String, locked: bool, milestone: Option<serde_json::Value>, node_id: String, number: i32, reactions: crate::models::WebhookIssueCommentCreatedIssueAllOfReactions, repository_url: String, state: State, title: String, updated_at: String, url: String, user: crate::models::WebhookIssueCommentCreatedIssueAllOfUser) -> WebhookIssueCommentDeletedIssue {
