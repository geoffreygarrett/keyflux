...
impl WebhookDependabotAlertReopened {
    pub fn new(action: Action, alert: crate::models::DependabotAlert, repository: crate::models::RepositoryWebhooks, sender: crate::models::SimpleUserWebhooks) -> WebhookDependabotAlertReopened {
