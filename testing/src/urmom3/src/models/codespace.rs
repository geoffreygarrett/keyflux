...
pub struct Codespace {
    ...
    pub billable_owner: Box<crate::models::SimpleUser>,
    #[serde(rename = "repository")]
    pub repository: Box<crate::models::MinimalRepository>,
    #[serde(rename = "machine")]
    pub machine: Option<Box<crate::models::NullableCodespaceMachine>>,
    ...
    pub git_status: Box<crate::models::CodespaceGitStatus>,
    /// The initally assigned location of a new codespace.
    #[serde(rename = "location")]
    pub location: Location,
    /// The number of minutes of inactivity after which this codespace will be automatically stopped.
    #[serde(rename = "idle_timeout_minutes")]
    ...
    #[serde(rename = "publish_url", skip_serializing_if = "Option::is_none")]
    ...
    pub runtime_constraints: Option<Box<crate::models::CodespaceRuntimeConstraints>>,
    /// Whether or not a codespace has a pending async operation. This would mean that the codespace is temporarily unavailable. The only thing that you can do with a codespace in this state is delete it.
    #[serde(rename = "pending_operation", skip_serializing_if = "Option::is_none")]
    pub pending_operation: Option<bool>,
    /// Text to show user when codespace is disabled by a pending operation
    #[serde(rename = "pending_operation_disabled_reason", skip_serializing_if = "Option::is_none")]
    pub pending_operation_disabled_reason: Option<String>,
    /// Text to show user when codespace idle timeout minutes has been overriden by an organization policy
    #[serde(rename = "idle_timeout_notice", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "retention_expires_at", skip_serializing_if = "Option::is_none")]
    pub retention_expires_at: Option<String>,
    /// The text to display to a user when a codespace has been stopped for a potentially actionable reason.
    #[serde(rename = "last_known_stop_notice", skip_serializing_if = "Option::is_none")]
    pub last_known_stop_notice: Option<String>,
}

impl Codespace {
    /// A codespace.
    pub fn new(id: i64, name: String, environment_id: Option<String>, owner: crate::models::SimpleUser, billable_owner: crate::models::SimpleUser, repository: crate::models::MinimalRepository, machine: Option<crate::models::NullableCodespaceMachine>, prebuild: Option<bool>, created_at: String, updated_at: String, last_used_at: String, state: State, url: String, git_status: crate::models::CodespaceGitStatus, location: Location, idle_timeout_minutes: Option<i32>, web_url: String, machines_url: String, start_url: String, stop_url: String, pulls_url: Option<String>, recent_folders: Vec<String>) -> Codespace {
        Codespace {
            id,
            name,
            display_name: None,
