...
pub struct ReposUpdateBranchProtectionRequest {
    ...
    pub required_status_checks: Option<Box<crate::models::ReposUpdateBranchProtectionRequestRequiredStatusChecks>>,
    /// Enforce all configured restrictions for administrators. Set to `true` to enforce required status checks for repository administrators. Set to `null` to disable.
    #[serde(rename = "enforce_admins")]
    pub enforce_admins: Option<bool>,
    #[serde(rename = "required_pull_request_reviews")]
    pub required_pull_request_reviews: Option<Box<crate::models::ReposUpdateBranchProtectionRequestRequiredPullRequestReviews>>,
    #[serde(rename = "restrictions")]
    pub restrictions: Option<Box<crate::models::ReposUpdateBranchProtectionRequestRestrictions>>,
...
impl ReposUpdateBranchProtectionRequest {
    pub fn new(required_status_checks: Option<crate::models::ReposUpdateBranchProtectionRequestRequiredStatusChecks>, enforce_admins: Option<bool>, required_pull_request_reviews: Option<crate::models::ReposUpdateBranchProtectionRequestRequiredPullRequestReviews>, restrictions: Option<crate::models::ReposUpdateBranchProtectionRequestRestrictions>) -> ReposUpdateBranchProtectionRequest {
        ReposUpdateBranchProtectionRequest {
