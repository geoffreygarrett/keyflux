...
pub struct WebhookRepositoryEdited {
    ...
    pub changes: Box<crate::models::WebhookRepositoryEditedChanges>,
...
impl WebhookRepositoryEdited {
    pub fn new(action: Action, changes: crate::models::WebhookRepositoryEditedChanges, repository: crate::models::RepositoryWebhooks, sender: crate::models::SimpleUserWebhooks) -> WebhookRepositoryEdited {
