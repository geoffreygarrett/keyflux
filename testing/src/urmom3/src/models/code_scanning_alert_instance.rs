...
pub struct CodeScanningAlertInstance {
    ...
    pub state: Option<crate::models::CodeScanningAlertState>,
    ...
    pub location: Option<Box<crate::models::CodeScanningAlertLocation>>,
    ...
    pub classifications: Option<Vec<crate::models::CodeScanningAlertClassification>>,
}
