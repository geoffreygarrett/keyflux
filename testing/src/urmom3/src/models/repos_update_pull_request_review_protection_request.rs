...
pub struct ReposUpdatePullRequestReviewProtectionRequest {
    ...
    pub dismissal_restrictions: Option<Box<crate::models::ReposUpdateBranchProtectionRequestRequiredPullRequestReviewsDismissalRestrictions>>,
    ...
    pub bypass_pull_request_allowances: Option<Box<crate::models::ReposUpdateBranchProtectionRequestRequiredPullRequestReviewsBypassPullRequestAllowances>>,
}

impl ReposUpdatePullRequestReviewProtectionRequest {
    pub fn new() -> ReposUpdatePullRequestReviewProtectionRequest {
