...
/// RepositoryAdvisoryPrivateFork : A temporary private fork of the advisory's repository for collaborating on a fix.



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct RepositoryAdvisoryPrivateFork {
...
impl RepositoryAdvisoryPrivateFork {
