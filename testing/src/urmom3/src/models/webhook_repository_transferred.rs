...
pub struct WebhookRepositoryTransferred {
    ...
    pub changes: Box<crate::models::WebhookRepositoryTransferredChanges>,
...
impl WebhookRepositoryTransferred {
    pub fn new(action: Action, changes: crate::models::WebhookRepositoryTransferredChanges, repository: crate::models::RepositoryWebhooks, sender: crate::models::SimpleUserWebhooks) -> WebhookRepositoryTransferred {
