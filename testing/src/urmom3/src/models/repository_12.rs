...
/// Repository12 : A git repository



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct Repository12 {
    ...
    pub created_at: Option<Box<crate::models::OneOfLessThanIntegerCommaDateTimeGreaterThan>>,
    ...
    pub license: Option<Box<crate::models::License1>>,
    ...
    #[serde(rename = "owner")]
    pub owner: Option<Box<crate::models::User5>>,
    #[serde(rename = "permissions", skip_serializing_if = "Option::is_none")]
    pub permissions: Option<Box<crate::models::Repository11Permissions>>,
    ...
    pub pushed_at: Option<Box<crate::models::OneOfLessThanIntegerCommaDateTimeGreaterThan>>,
...
impl Repository12 {
    /// A git repository
    pub fn new(archive_url: String, archived: bool, assignees_url: String, blobs_url: String, branches_url: String, clone_url: String, collaborators_url: String, comments_url: String, commits_url: String, compare_url: String, contents_url: String, contributors_url: String, created_at: Option<crate::models::OneOfLessThanIntegerCommaDateTimeGreaterThan>, default_branch: String, deployments_url: String, description: Option<String>, downloads_url: String, events_url: String, fork: bool, forks: i32, forks_count: i32, forks_url: String, full_name: String, git_commits_url: String, git_refs_url: String, git_tags_url: String, git_url: String, has_downloads: bool, has_issues: bool, has_pages: bool, has_projects: bool, has_wiki: bool, has_discussions: bool, homepage: Option<String>, hooks_url: String, html_url: String, id: i64, issue_comment_url: String, issue_events_url: String, issues_url: String, keys_url: String, labels_url: String, language: Option<String>, languages_url: String, license: Option<crate::models::License1>, merges_url: String, milestones_url: String, mirror_url: Option<String>, name: String, node_id: String, notifications_url: String, open_issues: i32, open_issues_count: i32, owner: Option<crate::models::User5>, private: bool, pulls_url: String, pushed_at: Option<crate::models::OneOfLessThanIntegerCommaDateTimeGreaterThan>, releases_url: String, size: i32, ssh_url: String, stargazers_count: i32, stargazers_url: String, statuses_url: String, subscribers_url: String, subscription_url: String, svn_url: String, tags_url: String, teams_url: String, topics: Vec<String>, trees_url: String, updated_at: String, url: String, visibility: Visibility, watchers: i32, watchers_count: i32) -> Repository12 {
        Repository12 {
            ...
            contents_url,
            contributors_url,
            created_at: if let Some(x) = created_at {Some(Box::new(x))} else {None},
            default_branch,
