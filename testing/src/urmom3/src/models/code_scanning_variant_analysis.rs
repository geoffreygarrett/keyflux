...
pub struct CodeScanningVariantAnalysis {
    ...
    pub controller_repo: Box<crate::models::SimpleRepository>,
    #[serde(rename = "actor")]
    pub actor: Box<crate::models::SimpleUser>,
    #[serde(rename = "query_language")]
    pub query_language: crate::models::CodeScanningVariantAnalysisLanguage,
    ...
    pub scanned_repositories: Option<Vec<crate::models::CodeScanningVariantAnalysisScannedRepositoriesInner>>,
    #[serde(rename = "skipped_repositories", skip_serializing_if = "Option::is_none")]
    pub skipped_repositories: Option<Box<crate::models::CodeScanningVariantAnalysisSkippedRepositories>>,
}

impl CodeScanningVariantAnalysis {
    /// A run of a CodeQL query against one or more repositories.
    pub fn new(id: i32, controller_repo: crate::models::SimpleRepository, actor: crate::models::SimpleUser, query_language: crate::models::CodeScanningVariantAnalysisLanguage, query_pack_url: String, status: Status) -> CodeScanningVariantAnalysis {
