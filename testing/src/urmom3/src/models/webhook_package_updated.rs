...
pub struct WebhookPackageUpdated {
    ...
    pub package: Box<crate::models::WebhookPackageUpdatedPackage>,
...
impl WebhookPackageUpdated {
    pub fn new(action: Action, package: crate::models::WebhookPackageUpdatedPackage, repository: crate::models::RepositoryWebhooks, sender: crate::models::SimpleUserWebhooks) -> WebhookPackageUpdated {
