...
pub struct WebhookOrganizationRenamed {
    ...
    pub changes: Option<Box<crate::models::WebhookOrganizationRenamedChanges>>,
...
impl WebhookOrganizationRenamed {
    pub fn new(action: Action, organization: crate::models::OrganizationSimpleWebhooks, sender: crate::models::SimpleUserWebhooks) -> WebhookOrganizationRenamed {
