...
impl WebhookPullRequestEnqueued {
    pub fn new(action: Action, number: i32, pull_request: crate::models::PullRequest3, repository: crate::models::RepositoryWebhooks, sender: crate::models::SimpleUserWebhooks) -> WebhookPullRequestEnqueued {
