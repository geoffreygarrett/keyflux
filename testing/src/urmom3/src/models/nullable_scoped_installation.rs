...
pub struct NullableScopedInstallation {
    ...
    pub account: Box<crate::models::SimpleUser>,
}

impl NullableScopedInstallation {
    pub fn new(permissions: crate::models::AppPermissions, repository_selection: RepositorySelection, single_file_name: Option<String>, repositories_url: String, account: crate::models::SimpleUser) -> NullableScopedInstallation {
