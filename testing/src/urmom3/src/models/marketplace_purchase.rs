...
impl MarketplacePurchase {
    pub fn new(account: crate::models::WebhooksMarketplacePurchaseAccount, billing_cycle: String, free_trial_ends_on: Option<String>, on_free_trial: Option<bool>, plan: crate::models::WebhooksPreviousMarketplacePurchasePlan, unit_count: i32) -> MarketplacePurchase {
        MarketplacePurchase {
