...
pub struct GlobalAdvisory {
    ...
    #[serde(rename = "repository_advisory_url")]
    ...
    #[serde(rename = "source_code_location")]
    pub source_code_location: Option<String>,
    #[serde(rename = "identifiers")]
    pub identifiers: Option<Vec<crate::models::GlobalAdvisoryIdentifiersInner>>,
    ...
    pub vulnerabilities: Option<Vec<crate::models::Vulnerability>>,
    #[serde(rename = "cvss")]
    ...
    pub credits: Option<Vec<crate::models::GlobalAdvisoryCreditsInner>>,
}

impl GlobalAdvisory {
    /// A GitHub Security Advisory.
    pub fn new(ghsa_id: String, cve_id: Option<String>, url: String, html_url: String, repository_advisory_url: Option<String>, summary: String, description: Option<String>, r#type: RHashType, severity: Severity, source_code_location: Option<String>, identifiers: Option<Vec<crate::models::GlobalAdvisoryIdentifiersInner>>, references: Option<Vec<String>>, published_at: String, updated_at: String, github_reviewed_at: Option<String>, nvd_published_at: Option<String>, withdrawn_at: Option<String>, vulnerabilities: Option<Vec<crate::models::Vulnerability>>, cvss: Option<crate::models::GlobalAdvisoryCvss>, cwes: Option<Vec<crate::models::GlobalAdvisoryCwesInner>>, credits: Option<Vec<crate::models::GlobalAdvisoryCreditsInner>>) -> GlobalAdvisory {
        GlobalAdvisory {
            ghsa_id,
            cve_id,
            url,
