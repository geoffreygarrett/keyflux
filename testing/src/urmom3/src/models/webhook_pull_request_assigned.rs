...
pub struct WebhookPullRequestAssigned {
    ...
    pub pull_request: Box<crate::models::PullRequest>,
...
impl WebhookPullRequestAssigned {
    pub fn new(action: Action, assignee: Option<crate::models::WebhooksUser>, number: i32, pull_request: crate::models::PullRequest, repository: crate::models::RepositoryWebhooks, sender: crate::models::SimpleUserWebhooks) -> WebhookPullRequestAssigned {
