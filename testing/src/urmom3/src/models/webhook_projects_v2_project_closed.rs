...
impl WebhookProjectsV2ProjectClosed {
    pub fn new(action: Action, organization: crate::models::OrganizationSimpleWebhooks, projects_v2: crate::models::ProjectsV2, sender: crate::models::SimpleUserWebhooks) -> WebhookProjectsV2ProjectClosed {
