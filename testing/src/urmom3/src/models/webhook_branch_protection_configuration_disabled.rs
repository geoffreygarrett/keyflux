...
impl WebhookBranchProtectionConfigurationDisabled {
    pub fn new(action: Action, repository: crate::models::RepositoryWebhooks, sender: crate::models::SimpleUserWebhooks) -> WebhookBranchProtectionConfigurationDisabled {
