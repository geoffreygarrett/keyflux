...
pub struct WebhookDiscussionEdited {
    ...
    pub changes: Option<Box<crate::models::WebhookDiscussionEditedChanges>>,
...
impl WebhookDiscussionEdited {
    pub fn new(action: Action, discussion: crate::models::Discussion, repository: crate::models::RepositoryWebhooks, sender: crate::models::SimpleUserWebhooks) -> WebhookDiscussionEdited {
