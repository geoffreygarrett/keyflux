...
impl App1 {
    ...
    pub fn new(created_at: Option<String>, description: Option<String>, external_url: Option<String>, html_url: String, id: Option<i32>, name: String, node_id: String, owner: Option<crate::models::User>, updated_at: Option<String>) -> App1 {
        App1 {
            created_at,
            description,
            events: None,
