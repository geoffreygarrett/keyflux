...
pub struct WebhookMarketplacePurchasePendingChangeCancelled {
    ...
    pub marketplace_purchase: Box<crate::models::MarketplacePurchase2>,
...
impl WebhookMarketplacePurchasePendingChangeCancelled {
    pub fn new(action: Action, effective_date: String, marketplace_purchase: crate::models::MarketplacePurchase2, sender: crate::models::SimpleUserWebhooks) -> WebhookMarketplacePurchasePendingChangeCancelled {
