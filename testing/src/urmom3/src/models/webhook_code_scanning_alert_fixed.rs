...
pub struct WebhookCodeScanningAlertFixed {
    ...
    pub action: Action,
    #[serde(rename = "alert")]
    pub alert: Box<crate::models::WebhookCodeScanningAlertFixedAlert>,
...
impl WebhookCodeScanningAlertFixed {
    pub fn new(action: Action, alert: crate::models::WebhookCodeScanningAlertFixedAlert, commit_oid: String, r#ref: String, repository: crate::models::RepositoryWebhooks, sender: crate::models::SimpleUserWebhooks) -> WebhookCodeScanningAlertFixed {
