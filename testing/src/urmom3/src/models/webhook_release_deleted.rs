...
impl WebhookReleaseDeleted {
    pub fn new(action: Action, release: crate::models::WebhooksRelease, repository: crate::models::RepositoryWebhooks, sender: crate::models::SimpleUserWebhooks) -> WebhookReleaseDeleted {
