...
pub struct WebhookIssuesLabeled {
    ...
    #[serde(rename = "issue")]
    pub issue: Box<crate::models::Issue7>,
...
impl WebhookIssuesLabeled {
    pub fn new(action: Action, issue: crate::models::Issue7, repository: crate::models::RepositoryWebhooks, sender: crate::models::SimpleUserWebhooks) -> WebhookIssuesLabeled {
