...
pub struct TeamFull {
    ...
    pub organization: Box<crate::models::TeamOrganization>,
...
impl TeamFull {
    ...
    pub fn new(id: i32, node_id: String, url: String, html_url: String, name: String, slug: String, description: Option<String>, permission: String, members_url: String, repositories_url: String, members_count: i32, repos_count: i32, created_at: String, updated_at: String, organization: crate::models::TeamOrganization) -> TeamFull {
        TeamFull {
            id,
            node_id,
            url,
