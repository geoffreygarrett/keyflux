...
pub struct WebhookPullRequestReviewSubmitted {
    ...
    pub pull_request: Box<crate::models::SimplePullRequest2>,
...
impl WebhookPullRequestReviewSubmitted {
    pub fn new(action: Action, pull_request: crate::models::SimplePullRequest2, repository: crate::models::RepositoryWebhooks, review: crate::models::WebhooksReview, sender: crate::models::SimpleUserWebhooks) -> WebhookPullRequestReviewSubmitted {
