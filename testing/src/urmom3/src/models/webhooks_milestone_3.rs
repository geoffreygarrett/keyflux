...
impl WebhooksMilestone3 {
    ...
    pub fn new(closed_at: Option<String>, closed_issues: i32, created_at: String, creator: Option<crate::models::User>, description: Option<String>, due_on: Option<String>, html_url: String, id: i32, labels_url: String, node_id: String, number: i32, open_issues: i32, state: State, title: String, updated_at: String, url: String) -> WebhooksMilestone3 {
        WebhooksMilestone3 {
            closed_at,
            closed_issues,
            created_at,
