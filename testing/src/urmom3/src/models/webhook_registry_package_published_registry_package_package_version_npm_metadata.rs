...
pub struct WebhookRegistryPackagePublishedRegistryPackagePackageVersionNpmMetadata {
    ...
    pub author: Option<Box<crate::models::Deployment1Payload>>,
    #[serde(rename = "bugs", skip_serializing_if = "Option::is_none")]
    pub bugs: Option<Box<crate::models::Deployment1Payload>>,
    ...
    pub dist: Option<Box<crate::models::Deployment1Payload>>,
    ...
    pub repository: Option<Box<crate::models::Deployment1Payload>>,
    ...
    pub directories: Option<Box<crate::models::Deployment1Payload>>,
...
impl WebhookRegistryPackagePublishedRegistryPackagePackageVersionNpmMetadata {
    pub fn new() -> WebhookRegistryPackagePublishedRegistryPackagePackageVersionNpmMetadata {
