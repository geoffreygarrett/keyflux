...
pub struct WebhookOrganizationMemberInvitedInvitation {
    ...
    pub inviter: Option<Box<crate::models::User>>,
    #[serde(rename = "login")]
...
impl WebhookOrganizationMemberInvitedInvitation {
    ...
    pub fn new(created_at: String, email: Option<String>, failed_at: Option<String>, failed_reason: Option<String>, id: f32, invitation_teams_url: String, inviter: Option<crate::models::User>, login: Option<String>, node_id: String, role: String, team_count: f32) -> WebhookOrganizationMemberInvitedInvitation {
