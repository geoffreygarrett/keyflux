...
impl TimelineReviewedEvent {
    ...
    pub fn new(event: String, id: i32, node_id: String, user: crate::models::SimpleUser, body: Option<String>, state: String, html_url: String, pull_request_url: String, _links: crate::models::TimelineReviewedEventLinks, commit_id: String, author_association: crate::models::AuthorAssociation) -> TimelineReviewedEvent {
