...
pub struct WebhookPackagePublished {
    ...
    pub package: Box<crate::models::WebhookPackagePublishedPackage>,
...
impl WebhookPackagePublished {
    pub fn new(action: Action, package: crate::models::WebhookPackagePublishedPackage, sender: crate::models::SimpleUserWebhooks) -> WebhookPackagePublished {
