...
pub struct CommitComparison {
    ...
    pub base_commit: Box<crate::models::Commit>,
    #[serde(rename = "merge_base_commit")]
    pub merge_base_commit: Box<crate::models::Commit>,
    #[serde(rename = "status")]
    pub status: Status,
    ...
    pub files: Option<Vec<crate::models::DiffEntry>>,
}

impl CommitComparison {
    /// Commit Comparison
    pub fn new(url: String, html_url: String, permalink_url: String, diff_url: String, patch_url: String, base_commit: crate::models::Commit, merge_base_commit: crate::models::Commit, status: Status, ahead_by: i32, behind_by: i32, total_commits: i32, commits: Vec<crate::models::Commit>) -> CommitComparison {
        CommitComparison {
            url,
            html_url,
            permalink_url,
