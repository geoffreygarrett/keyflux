...
impl WebhookOrganizationMemberAdded {
    pub fn new(action: Action, membership: crate::models::WebhooksMembership, organization: crate::models::OrganizationSimpleWebhooks, sender: crate::models::SimpleUserWebhooks) -> WebhookOrganizationMemberAdded {
