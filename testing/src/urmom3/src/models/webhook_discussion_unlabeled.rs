...
impl WebhookDiscussionUnlabeled {
    pub fn new(action: Action, discussion: crate::models::Discussion, label: crate::models::WebhooksLabel, repository: crate::models::RepositoryWebhooks, sender: crate::models::SimpleUserWebhooks) -> WebhookDiscussionUnlabeled {
