...
impl Migration {
    /// A migration.
    pub fn new(id: i64, owner: Option<crate::models::NullableSimpleUser>, guid: String, state: String, lock_repositories: bool, exclude_metadata: bool, exclude_git_data: bool, exclude_attachments: bool, exclude_releases: bool, exclude_owner_projects: bool, org_metadata_only: bool, repositories: Vec<crate::models::Repository>, url: String, created_at: String, updated_at: String, node_id: String) -> Migration {
        Migration {
            id,
