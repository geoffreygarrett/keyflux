...
pub struct Deployment1 {
    ...
    pub payload: Option<Box<crate::models::Deployment1Payload>>,
    #[serde(rename = "performed_via_github_app", skip_serializing_if = "Option::is_none")]
    pub performed_via_github_app: Option<Box<crate::models::App6>>,
...
impl Deployment1 {
    ...
    pub fn new(created_at: String, creator: Option<crate::models::User>, description: Option<String>, environment: String, id: i32, node_id: String, original_environment: String, payload: Option<crate::models::Deployment1Payload>, r#ref: String, repository_url: String, sha: String, statuses_url: String, task: String, updated_at: String, url: String) -> Deployment1 {
        Deployment1 {
            created_at,
