...
pub struct WebhookMetaDeletedHook {
    ...
    pub active: bool,
    #[serde(rename = "config")]
    pub config: Box<crate::models::WebhookMetaDeletedHookConfig>,
...
impl WebhookMetaDeletedHook {
    ...
    pub fn new(active: bool, config: crate::models::WebhookMetaDeletedHookConfig, created_at: String, events: Events, id: i32, name: String, r#type: String, updated_at: String) -> WebhookMetaDeletedHook {
