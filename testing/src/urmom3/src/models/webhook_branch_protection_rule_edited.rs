...
pub struct WebhookBranchProtectionRuleEdited {
    ...
    pub changes: Option<Box<crate::models::WebhookBranchProtectionRuleEditedChanges>>,
    ...
    #[serde(rename = "rule")]
    pub rule: Box<crate::models::WebhooksRule>,
    #[serde(rename = "sender")]
    pub sender: Box<crate::models::SimpleUserWebhooks>,
}

impl WebhookBranchProtectionRuleEdited {
    pub fn new(action: Action, repository: crate::models::RepositoryWebhooks, rule: crate::models::WebhooksRule, sender: crate::models::SimpleUserWebhooks) -> WebhookBranchProtectionRuleEdited {
