...
pub struct WebhookRepositoryRenamed {
    ...
    pub changes: Box<crate::models::WebhookRepositoryRenamedChanges>,
...
impl WebhookRepositoryRenamed {
    pub fn new(action: Action, changes: crate::models::WebhookRepositoryRenamedChanges, repository: crate::models::RepositoryWebhooks, sender: crate::models::SimpleUserWebhooks) -> WebhookRepositoryRenamed {
