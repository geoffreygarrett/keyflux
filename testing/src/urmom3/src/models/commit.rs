...
impl Commit {
    pub fn new(author: crate::models::Committer, committer: crate::models::Committer, distinct: bool, id: String, message: String, timestamp: String, tree_id: String, url: String) -> Commit {
        Commit {
            added: None,
