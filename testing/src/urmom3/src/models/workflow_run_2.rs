...
pub struct WorkflowRun2 {
    ...
    pub head_commit: Box<crate::models::SimpleCommit>,
    #[serde(rename = "head_repository")]
    pub head_repository: Box<crate::models::RepositoryLite>,
    ...
    #[serde(rename = "path")]
    pub path: String,
    #[serde(rename = "previous_attempt_url")]
    pub previous_attempt_url: Option<String>,
    #[serde(rename = "pull_requests")]
    pub pull_requests: Vec<crate::models::WorkflowRun2PullRequestsInner>,
    ...
    pub repository: Box<crate::models::RepositoryLite>,
...
impl WorkflowRun2 {
    pub fn new(actor: Option<crate::models::User>, artifacts_url: String, cancel_url: String, check_suite_id: i32, check_suite_node_id: String, check_suite_url: String, conclusion: Option<Conclusion>, created_at: String, event: String, head_branch: Option<String>, head_commit: crate::models::SimpleCommit, head_repository: crate::models::RepositoryLite, head_sha: String, html_url: String, id: i32, jobs_url: String, logs_url: String, name: Option<String>, node_id: String, path: String, previous_attempt_url: Option<String>, pull_requests: Vec<crate::models::WorkflowRun2PullRequestsInner>, repository: crate::models::RepositoryLite, rerun_url: String, run_attempt: i32, run_number: i32, run_started_at: String, status: Status, triggering_actor: Option<crate::models::User>, updated_at: String, url: String, workflow_id: i32, workflow_url: String, display_title: String) -> WorkflowRun2 {
        WorkflowRun2 {
