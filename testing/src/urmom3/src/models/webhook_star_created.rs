...
impl WebhookStarCreated {
    pub fn new(action: Action, repository: crate::models::RepositoryWebhooks, sender: crate::models::SimpleUserWebhooks, starred_at: Option<String>) -> WebhookStarCreated {
        WebhookStarCreated {
            action,
            enterprise: None,
            installation: None,
