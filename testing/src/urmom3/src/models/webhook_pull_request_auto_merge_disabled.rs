...
pub struct WebhookPullRequestAutoMergeDisabled {
    ...
    pub pull_request: Box<crate::models::PullRequest1>,
    #[serde(rename = "reason")]
    pub reason: String,
...
impl WebhookPullRequestAutoMergeDisabled {
    pub fn new(action: Action, number: i32, pull_request: crate::models::PullRequest1, reason: String, repository: crate::models::RepositoryWebhooks, sender: crate::models::SimpleUserWebhooks) -> WebhookPullRequestAutoMergeDisabled {
