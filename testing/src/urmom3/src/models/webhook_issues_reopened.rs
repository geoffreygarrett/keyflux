...
pub struct WebhookIssuesReopened {
    ...
    #[serde(rename = "issue")]
    pub issue: Box<crate::models::Issue12>,
...
impl WebhookIssuesReopened {
    pub fn new(action: Action, issue: crate::models::Issue12, repository: crate::models::RepositoryWebhooks, sender: crate::models::SimpleUserWebhooks) -> WebhookIssuesReopened {
