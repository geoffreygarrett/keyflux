...
/// Issue2 : The [issue](https://docs.github.com/rest/issues/issues#get-an-issue) itself.
...
pub struct Issue2 {
    ...
    pub performed_via_github_app: Option<Box<crate::models::App>>,
...
impl Issue2 {
    ...
    pub fn new(active_lock_reason: Option<ActiveLockReason>, assignees: Vec<crate::models::User3>, author_association: AuthorAssociation, body: Option<String>, closed_at: Option<String>, comments: i32, comments_url: String, created_at: String, events_url: String, html_url: String, id: i64, labels_url: String, milestone: Option<crate::models::Milestone>, node_id: String, number: i32, reactions: crate::models::Reactions, repository_url: String, title: String, updated_at: String, url: String, user: Option<crate::models::User2>) -> Issue2 {
        Issue2 {
            active_lock_reason,
            assignee: None,
            assignees,
