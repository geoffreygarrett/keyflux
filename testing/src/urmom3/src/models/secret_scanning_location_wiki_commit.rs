...
impl SecretScanningLocationWikiCommit {
    ...
    pub fn new(path: String, start_line: f32, end_line: f32, start_column: f32, end_column: f32, blob_sha: String, page_url: String, commit_sha: String, commit_url: String) -> SecretScanningLocationWikiCommit {
