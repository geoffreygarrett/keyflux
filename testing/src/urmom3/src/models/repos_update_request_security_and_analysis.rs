...
pub struct ReposUpdateRequestSecurityAndAnalysis {
    ...
    pub advanced_security: Option<Box<crate::models::ReposUpdateRequestSecurityAndAnalysisAdvancedSecurity>>,
    #[serde(rename = "secret_scanning", skip_serializing_if = "Option::is_none")]
    pub secret_scanning: Option<Box<crate::models::ReposUpdateRequestSecurityAndAnalysisSecretScanning>>,
    #[serde(rename = "secret_scanning_push_protection", skip_serializing_if = "Option::is_none")]
    pub secret_scanning_push_protection: Option<Box<crate::models::ReposUpdateRequestSecurityAndAnalysisSecretScanningPushProtection>>,
}
