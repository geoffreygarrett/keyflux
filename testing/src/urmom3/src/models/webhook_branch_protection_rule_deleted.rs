...
impl WebhookBranchProtectionRuleDeleted {
    pub fn new(action: Action, repository: crate::models::RepositoryWebhooks, rule: crate::models::WebhooksRule, sender: crate::models::SimpleUserWebhooks) -> WebhookBranchProtectionRuleDeleted {
