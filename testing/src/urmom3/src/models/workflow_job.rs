...
/// WorkflowJob : The workflow job. Many `workflow_job` keys, such as `head_sha`, `conclusion`, and `started_at` are the same as those in a [`check_run`](#check_run) object.
...
pub struct WorkflowJob {
    ...
    #[serde(rename = "steps")]
    pub steps: Vec<crate::models::WorkflowStep>,
    #[serde(rename = "url")]
    pub url: String,
}
...
impl WorkflowJob {
    ...
    pub fn new(check_run_url: String, completed_at: Option<String>, conclusion: Option<Conclusion>, created_at: String, head_sha: String, html_url: String, id: i32, labels: Vec<String>, name: String, node_id: String, run_attempt: i32, run_id: f32, run_url: String, runner_group_id: Option<i32>, runner_group_name: Option<String>, runner_id: Option<i32>, runner_name: Option<String>, started_at: String, status: Status, head_branch: Option<String>, workflow_name: Option<String>, steps: Vec<crate::models::WorkflowStep>, url: String) -> WorkflowJob {
        WorkflowJob {
            check_run_url,
            completed_at,
            conclusion,
