...
pub struct WebhookPullRequestUnlocked {
    ...
    pub pull_request: Box<crate::models::PullRequest13>,
...
impl WebhookPullRequestUnlocked {
    pub fn new(action: Action, number: i32, pull_request: crate::models::PullRequest13, repository: crate::models::RepositoryWebhooks, sender: crate::models::SimpleUserWebhooks) -> WebhookPullRequestUnlocked {
