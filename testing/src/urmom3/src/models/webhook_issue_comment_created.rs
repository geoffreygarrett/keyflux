...
pub struct WebhookIssueCommentCreated {
    ...
    pub comment: Box<crate::models::IssueComment>,
    ...
    #[serde(rename = "issue")]
    pub issue: Box<crate::models::WebhookIssueCommentCreatedIssue>,
...
impl WebhookIssueCommentCreated {
    pub fn new(action: Action, comment: crate::models::IssueComment, issue: crate::models::WebhookIssueCommentCreatedIssue, repository: crate::models::RepositoryWebhooks, sender: crate::models::SimpleUserWebhooks) -> WebhookIssueCommentCreated {
