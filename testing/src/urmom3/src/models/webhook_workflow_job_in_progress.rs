...
pub struct WebhookWorkflowJobInProgress {
    ...
    pub workflow_job: Box<crate::models::WebhookWorkflowJobInProgressWorkflowJob>,
...
impl WebhookWorkflowJobInProgress {
    pub fn new(action: Action, repository: crate::models::RepositoryWebhooks, sender: crate::models::SimpleUserWebhooks, workflow_job: crate::models::WebhookWorkflowJobInProgressWorkflowJob) -> WebhookWorkflowJobInProgress {
