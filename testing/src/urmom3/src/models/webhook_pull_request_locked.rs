...
pub struct WebhookPullRequestLocked {
    ...
    pub pull_request: Box<crate::models::PullRequest5>,
...
impl WebhookPullRequestLocked {
    pub fn new(action: Action, number: i32, pull_request: crate::models::PullRequest5, repository: crate::models::RepositoryWebhooks, sender: crate::models::SimpleUserWebhooks) -> WebhookPullRequestLocked {
