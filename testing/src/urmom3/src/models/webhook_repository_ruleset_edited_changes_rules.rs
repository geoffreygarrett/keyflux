...
pub struct WebhookRepositoryRulesetEditedChangesRules {
    ...
    pub added: Option<Vec<crate::models::RepositoryRule>>,
    #[serde(rename = "deleted", skip_serializing_if = "Option::is_none")]
    pub deleted: Option<Vec<crate::models::RepositoryRule>>,
    #[serde(rename = "updated", skip_serializing_if = "Option::is_none")]
    pub updated: Option<Vec<crate::models::WebhookRepositoryRulesetEditedChangesRulesUpdatedInner>>,
}
