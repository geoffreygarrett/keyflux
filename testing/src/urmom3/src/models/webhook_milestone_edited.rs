...
pub struct WebhookMilestoneEdited {
    ...
    pub changes: Box<crate::models::WebhookMilestoneEditedChanges>,
    ...
    pub milestone: Box<crate::models::WebhooksMilestone>,
...
impl WebhookMilestoneEdited {
    pub fn new(action: Action, changes: crate::models::WebhookMilestoneEditedChanges, milestone: crate::models::WebhooksMilestone, repository: crate::models::RepositoryWebhooks, sender: crate::models::SimpleUserWebhooks) -> WebhookMilestoneEdited {
