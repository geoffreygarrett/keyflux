...
impl WebhookOrgBlockUnblocked {
    pub fn new(action: Action, blocked_user: Option<crate::models::WebhooksUser>, organization: crate::models::OrganizationSimpleWebhooks, sender: crate::models::SimpleUserWebhooks) -> WebhookOrgBlockUnblocked {
