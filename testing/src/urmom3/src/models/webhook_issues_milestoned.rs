...
pub struct WebhookIssuesMilestoned {
    ...
    #[serde(rename = "issue")]
    pub issue: Box<crate::models::Issue9>,
...
impl WebhookIssuesMilestoned {
    pub fn new(action: Action, issue: crate::models::Issue9, milestone: crate::models::WebhooksMilestone, repository: crate::models::RepositoryWebhooks, sender: crate::models::SimpleUserWebhooks) -> WebhookIssuesMilestoned {
