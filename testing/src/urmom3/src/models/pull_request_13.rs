...
pub struct PullRequest13 {
    ...
    pub auto_merge: Option<Box<crate::models::PullRequestAutoMerge2>>,
    #[serde(rename = "base")]
...
impl PullRequest13 {
    pub fn new(_links: crate::models::WebhooksPullRequest5Links, active_lock_reason: Option<ActiveLockReason>, assignee: Option<crate::models::User>, assignees: Vec<crate::models::User>, author_association: AuthorAssociation, auto_merge: Option<crate::models::PullRequestAutoMerge2>, base: crate::models::PullRequestBase, body: Option<String>, closed_at: Option<String>, comments_url: String, commits_url: String, created_at: String, diff_url: String, draft: bool, head: crate::models::WebhookPullRequestReviewCommentDeletedPullRequestHead, html_url: String, id: i32, issue_url: String, labels: Vec<crate::models::Label>, locked: bool, merge_commit_sha: Option<String>, merged_at: Option<String>, milestone: Option<crate::models::Milestone1>, node_id: String, number: i32, patch_url: String, requested_reviewers: Vec<crate::models::WebhooksPullRequest5RequestedReviewersInner>, requested_teams: Vec<crate::models::Team>, review_comment_url: String, review_comments_url: String, state: State, statuses_url: String, title: String, updated_at: String, url: String, user: Option<crate::models::User1>) -> PullRequest13 {
        PullRequest13 {
