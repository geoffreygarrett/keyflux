...
impl WebhookDiscussionCommentCreated {
    pub fn new(action: Action, comment: crate::models::WebhooksComment, discussion: crate::models::Discussion, repository: crate::models::RepositoryWebhooks, sender: crate::models::SimpleUserWebhooks) -> WebhookDiscussionCommentCreated {
