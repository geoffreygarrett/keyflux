...
/// WebhookIssueCommentEditedIssue : The [issue](https://docs.github.com/rest/issues/issues#get-an-issue) the comment belongs to.



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct WebhookIssueCommentEditedIssue {
