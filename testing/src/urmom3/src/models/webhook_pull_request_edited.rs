...
pub struct WebhookPullRequestEdited {
    ...
    pub changes: Box<crate::models::WebhookPullRequestEditedChanges>,
...
impl WebhookPullRequestEdited {
    pub fn new(action: Action, changes: crate::models::WebhookPullRequestEditedChanges, number: i32, pull_request: crate::models::PullRequestWebhook, repository: crate::models::RepositoryWebhooks) -> WebhookPullRequestEdited {
