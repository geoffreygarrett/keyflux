...
impl WebhookMilestoneCreated {
    pub fn new(action: Action, milestone: crate::models::WebhooksMilestone3, repository: crate::models::RepositoryWebhooks, sender: crate::models::SimpleUserWebhooks) -> WebhookMilestoneCreated {
