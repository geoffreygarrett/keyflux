...
pub struct WebhookWorkflowRunInProgress {
    ...
    pub workflow_run: Box<crate::models::WorkflowRun1>,
}

impl WebhookWorkflowRunInProgress {
    pub fn new(action: Action, repository: crate::models::RepositoryWebhooks, sender: crate::models::SimpleUserWebhooks, workflow: Option<crate::models::WebhooksWorkflow>, workflow_run: crate::models::WorkflowRun1) -> WebhookWorkflowRunInProgress {
