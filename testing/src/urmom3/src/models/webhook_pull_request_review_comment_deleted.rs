...
pub struct WebhookPullRequestReviewCommentDeleted {
    ...
    pub pull_request: Box<crate::models::WebhookPullRequestReviewCommentDeletedPullRequest>,
...
impl WebhookPullRequestReviewCommentDeleted {
    pub fn new(action: Action, comment: crate::models::WebhooksReviewComment, pull_request: crate::models::WebhookPullRequestReviewCommentDeletedPullRequest, repository: crate::models::RepositoryWebhooks, sender: crate::models::SimpleUserWebhooks) -> WebhookPullRequestReviewCommentDeleted {
