...
pub struct WebhookRegistryPackageUpdatedRegistryPackagePackageVersion {
    #[serde(rename = "author")]
    pub author: Box<crate::models::WebhookRegistryPackagePublishedRegistryPackageOwner>,
    #[serde(rename = "body")]
    pub body: String,
    ...
    pub docker_metadata: Option<Vec<crate::models::WebhookRegistryPackageUpdatedRegistryPackagePackageVersionDockerMetadataInner>>,
    ...
    pub package_files: Vec<crate::models::WebhookRegistryPackageUpdatedRegistryPackagePackageVersionPackageFilesInner>,
    ...
    pub release: Option<Box<crate::models::WebhookRegistryPackageUpdatedRegistryPackagePackageVersionRelease>>,
...
impl WebhookRegistryPackageUpdatedRegistryPackagePackageVersion {
    pub fn new(author: crate::models::WebhookRegistryPackagePublishedRegistryPackageOwner, body: String, body_html: String, created_at: String, description: String, html_url: String, id: i32, installation_command: String, metadata: Vec<::std::collections::HashMap<String, serde_json::Value>>, name: String, package_files: Vec<crate::models::WebhookRegistryPackageUpdatedRegistryPackagePackageVersionPackageFilesInner>, package_url: String, summary: String, target_commitish: String, target_oid: String, updated_at: String, version: String) -> WebhookRegistryPackageUpdatedRegistryPackagePackageVersion {
