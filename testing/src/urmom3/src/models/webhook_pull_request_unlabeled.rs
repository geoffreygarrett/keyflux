...
pub struct WebhookPullRequestUnlabeled {
    ...
    pub pull_request: Box<crate::models::PullRequest12>,
...
impl WebhookPullRequestUnlabeled {
    pub fn new(action: Action, number: i32, pull_request: crate::models::PullRequest12, repository: crate::models::RepositoryWebhooks, sender: crate::models::SimpleUserWebhooks) -> WebhookPullRequestUnlabeled {
