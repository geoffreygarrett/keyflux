...
pub struct ReposCreateOrUpdateFileContentsRequest {
    ...
    pub committer: Option<Box<crate::models::ReposCreateOrUpdateFileContentsRequestCommitter>>,
    #[serde(rename = "author", skip_serializing_if = "Option::is_none")]
    pub author: Option<Box<crate::models::ReposCreateOrUpdateFileContentsRequestAuthor>>,
}
