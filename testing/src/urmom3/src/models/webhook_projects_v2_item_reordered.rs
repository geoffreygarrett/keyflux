...
pub struct WebhookProjectsV2ItemReordered {
    ...
    pub changes: Box<crate::models::WebhookProjectsV2ItemReorderedChanges>,
...
impl WebhookProjectsV2ItemReordered {
    pub fn new(action: Action, changes: crate::models::WebhookProjectsV2ItemReorderedChanges, organization: crate::models::OrganizationSimpleWebhooks, projects_v2_item: crate::models::ProjectsV2Item, sender: crate::models::SimpleUserWebhooks) -> WebhookProjectsV2ItemReordered {
