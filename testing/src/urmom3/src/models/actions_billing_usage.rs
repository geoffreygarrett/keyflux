...
pub struct ActionsBillingUsage {
    ...
    pub minutes_used_breakdown: Box<crate::models::ActionsBillingUsageMinutesUsedBreakdown>,
}

impl ActionsBillingUsage {
    pub fn new(total_minutes_used: i32, total_paid_minutes_used: i32, included_minutes: i32, minutes_used_breakdown: crate::models::ActionsBillingUsageMinutesUsedBreakdown) -> ActionsBillingUsage {
        ActionsBillingUsage {
            total_minutes_used,
