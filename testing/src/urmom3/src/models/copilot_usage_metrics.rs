...
pub struct CopilotUsageMetrics {
    ...
    pub breakdown: Option<Vec<crate::models::CopilotUsageMetricsBreakdownInner>>,
}

impl CopilotUsageMetrics {
    /// Summary of Copilot usage.
    pub fn new(day: String, breakdown: Option<Vec<crate::models::CopilotUsageMetricsBreakdownInner>>) -> CopilotUsageMetrics {
        CopilotUsageMetrics {
            day,
