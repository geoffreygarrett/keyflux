...
impl WebhookPullRequestOpened {
    pub fn new(action: Action, number: i32, pull_request: crate::models::PullRequestWebhook, repository: crate::models::RepositoryWebhooks, sender: crate::models::SimpleUserWebhooks) -> WebhookPullRequestOpened {
