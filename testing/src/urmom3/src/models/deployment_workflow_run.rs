...
pub struct DeploymentWorkflowRun {
    ...
    #[serde(rename = "status")]
    pub status: Status,
    #[serde(rename = "triggering_actor", skip_serializing_if = "Option::is_none")]
...
impl DeploymentWorkflowRun {
    pub fn new(actor: Option<crate::models::User>, check_suite_id: i32, check_suite_node_id: String, conclusion: Option<Conclusion>, created_at: String, display_title: String, event: String, head_branch: String, head_sha: String, html_url: String, id: i32, name: String, node_id: String, path: String, pull_requests: Vec<crate::models::CheckRunPullRequest>, run_attempt: i32, run_number: i32, run_started_at: String, status: Status, updated_at: String, url: String, workflow_id: i32) -> DeploymentWorkflowRun {
