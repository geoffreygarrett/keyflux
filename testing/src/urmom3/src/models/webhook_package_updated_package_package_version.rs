...
pub struct WebhookPackageUpdatedPackagePackageVersion {
    ...
    pub package_files: Vec<crate::models::WebhookPackageUpdatedPackagePackageVersionPackageFilesInner>,
    ...
    pub release: Option<Box<crate::models::WebhookPackageUpdatedPackagePackageVersionRelease>>,
...
impl WebhookPackageUpdatedPackagePackageVersion {
    pub fn new(author: Option<crate::models::User>, body: String, body_html: String, created_at: String, description: String, html_url: String, id: i32, installation_command: String, metadata: Vec<::std::collections::HashMap<String, serde_json::Value>>, name: String, package_files: Vec<crate::models::WebhookPackageUpdatedPackagePackageVersionPackageFilesInner>, summary: String, target_commitish: String, target_oid: String, updated_at: String, version: String) -> WebhookPackageUpdatedPackagePackageVersion {
