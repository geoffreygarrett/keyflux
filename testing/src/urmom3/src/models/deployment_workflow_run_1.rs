...
impl DeploymentWorkflowRun1 {
    pub fn new(actor: Option<crate::models::User>, check_suite_id: i32, check_suite_node_id: String, conclusion: Option<Conclusion>, created_at: String, display_title: String, event: String, head_branch: String, head_sha: String, html_url: String, id: i32, name: String, node_id: String, path: String, pull_requests: Vec<crate::models::CheckRunPullRequest>, run_attempt: i32, run_number: i32, run_started_at: String, status: Status, triggering_actor: Option<crate::models::User>, updated_at: String, url: String, workflow_id: i32) -> DeploymentWorkflowRun1 {
