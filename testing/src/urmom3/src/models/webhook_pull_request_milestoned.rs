...
impl WebhookPullRequestMilestoned {
    pub fn new(action: Action, number: i32, pull_request: crate::models::WebhooksPullRequest5, repository: crate::models::RepositoryWebhooks) -> WebhookPullRequestMilestoned {
