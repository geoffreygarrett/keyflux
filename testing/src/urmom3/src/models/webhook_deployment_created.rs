...
pub struct WebhookDeploymentCreated {
    ...
    pub workflow_run: Option<Box<crate::models::DeploymentWorkflowRun>>,
}

impl WebhookDeploymentCreated {
    pub fn new(action: Action, deployment: crate::models::Deployment, repository: crate::models::RepositoryWebhooks, sender: crate::models::SimpleUserWebhooks, workflow: Option<crate::models::WebhooksWorkflow>, workflow_run: Option<crate::models::DeploymentWorkflowRun>) -> WebhookDeploymentCreated {
