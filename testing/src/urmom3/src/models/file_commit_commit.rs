...
pub struct FileCommitCommit {
    ...
    pub author: Option<Box<crate::models::FileCommitCommitAuthor>>,
    #[serde(rename = "committer", skip_serializing_if = "Option::is_none")]
    pub committer: Option<Box<crate::models::FileCommitCommitAuthor>>,
    #[serde(rename = "message", skip_serializing_if = "Option::is_none")]
    pub message: Option<String>,
    #[serde(rename = "tree", skip_serializing_if = "Option::is_none")]
    pub tree: Option<Box<crate::models::FileCommitCommitTree>>,
    #[serde(rename = "parents", skip_serializing_if = "Option::is_none")]
    pub parents: Option<Vec<crate::models::FileCommitCommitParentsInner>>,
    #[serde(rename = "verification", skip_serializing_if = "Option::is_none")]
    pub verification: Option<Box<crate::models::FileCommitCommitVerification>>,
}
