...
pub struct FeedLinks {
    ...
    pub timeline: Box<crate::models::LinkWithType>,
    #[serde(rename = "user")]
    pub user: Box<crate::models::LinkWithType>,
    #[serde(rename = "security_advisories", skip_serializing_if = "Option::is_none")]
    pub security_advisories: Option<Box<crate::models::LinkWithType>>,
    #[serde(rename = "current_user", skip_serializing_if = "Option::is_none")]
    pub current_user: Option<Box<crate::models::LinkWithType>>,
    #[serde(rename = "current_user_public", skip_serializing_if = "Option::is_none")]
    pub current_user_public: Option<Box<crate::models::LinkWithType>>,
    #[serde(rename = "current_user_actor", skip_serializing_if = "Option::is_none")]
    pub current_user_actor: Option<Box<crate::models::LinkWithType>>,
    #[serde(rename = "current_user_organization", skip_serializing_if = "Option::is_none")]
    pub current_user_organization: Option<Box<crate::models::LinkWithType>>,
    #[serde(rename = "current_user_organizations", skip_serializing_if = "Option::is_none")]
    pub current_user_organizations: Option<Vec<crate::models::LinkWithType>>,
    #[serde(rename = "repository_discussions", skip_serializing_if = "Option::is_none")]
    pub repository_discussions: Option<Box<crate::models::LinkWithType>>,
    #[serde(rename = "repository_discussions_category", skip_serializing_if = "Option::is_none")]
    pub repository_discussions_category: Option<Box<crate::models::LinkWithType>>,
}

impl FeedLinks {
    pub fn new(timeline: crate::models::LinkWithType, user: crate::models::LinkWithType) -> FeedLinks {
        FeedLinks {
