...
pub struct WebhookIssuesOpened {
    ...
    pub changes: Option<Box<crate::models::WebhookIssuesOpenedChanges>>,
    ...
    #[serde(rename = "issue")]
    pub issue: Box<crate::models::Issue11>,
...
impl WebhookIssuesOpened {
    pub fn new(action: Action, issue: crate::models::Issue11, repository: crate::models::RepositoryWebhooks, sender: crate::models::SimpleUserWebhooks) -> WebhookIssuesOpened {
        WebhookIssuesOpened {
            action,
            changes: None,
            enterprise: None,
