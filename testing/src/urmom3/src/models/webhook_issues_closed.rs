...
pub struct WebhookIssuesClosed {
    ...
    #[serde(rename = "issue")]
    pub issue: Box<crate::models::WebhookIssuesClosedIssue>,
...
impl WebhookIssuesClosed {
    pub fn new(action: Action, issue: crate::models::WebhookIssuesClosedIssue, repository: crate::models::RepositoryWebhooks, sender: crate::models::SimpleUserWebhooks) -> WebhookIssuesClosed {
        WebhookIssuesClosed {
            action,
            enterprise: None,
            installation: None,
