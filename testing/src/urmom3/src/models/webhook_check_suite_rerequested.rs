...
pub struct WebhookCheckSuiteRerequested {
    ...
    pub check_suite: Box<crate::models::WebhookCheckSuiteRerequestedCheckSuite>,
...
impl WebhookCheckSuiteRerequested {
    pub fn new(action: Action, check_suite: crate::models::WebhookCheckSuiteRerequestedCheckSuite, repository: crate::models::RepositoryWebhooks, sender: crate::models::SimpleUserWebhooks) -> WebhookCheckSuiteRerequested {
