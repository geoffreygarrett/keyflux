...
impl WebhookCheckRunCreated {
    pub fn new(check_run: crate::models::CheckRunWithSimpleCheckSuite, repository: crate::models::RepositoryWebhooks, sender: crate::models::SimpleUserWebhooks) -> WebhookCheckRunCreated {
