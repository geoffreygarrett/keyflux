...
pub struct FullRepository {
    ...
    #[serde(rename = "template_repository", skip_serializing_if = "Option::is_none")]
    pub template_repository: Option<Box<crate::models::NullableRepository>>,
    ...
    pub source: Option<Box<crate::models::Repository>>,
    #[serde(rename = "forks")]
    pub forks: i32,
    ...
    pub code_of_conduct: Option<Box<crate::models::CodeOfConductSimple>>,
...
impl FullRepository {
    /// Full Repository
    pub fn new(id: i64, node_id: String, name: String, full_name: String, owner: crate::models::SimpleUser, private: bool, html_url: String, description: Option<String>, fork: bool, url: String, archive_url: String, assignees_url: String, blobs_url: String, branches_url: String, collaborators_url: String, comments_url: String, commits_url: String, compare_url: String, contents_url: String, contributors_url: String, deployments_url: String, downloads_url: String, events_url: String, forks_url: String, git_commits_url: String, git_refs_url: String, git_tags_url: String, git_url: String, issue_comment_url: String, issue_events_url: String, issues_url: String, keys_url: String, labels_url: String, languages_url: String, merges_url: String, milestones_url: String, notifications_url: String, pulls_url: String, releases_url: String, ssh_url: String, stargazers_url: String, statuses_url: String, subscribers_url: String, subscription_url: String, tags_url: String, teams_url: String, trees_url: String, clone_url: String, mirror_url: Option<String>, hooks_url: String, svn_url: String, homepage: Option<String>, language: Option<String>, forks_count: i32, stargazers_count: i32, watchers_count: i32, size: i32, default_branch: String, open_issues_count: i32, has_issues: bool, has_projects: bool, has_wiki: bool, has_pages: bool, has_discussions: bool, archived: bool, disabled: bool, pushed_at: String, created_at: String, updated_at: String, subscribers_count: i32, network_count: i32, license: Option<crate::models::NullableLicenseSimple>, forks: i32, open_issues: i32, watchers: i32) -> FullRepository {
        FullRepository {
            id,
            node_id,
            name,
