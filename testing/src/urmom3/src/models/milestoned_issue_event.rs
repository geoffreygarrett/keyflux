...
impl MilestonedIssueEvent {
    ...
    pub fn new(id: i32, node_id: String, url: String, actor: crate::models::SimpleUser, event: String, commit_id: Option<String>, commit_url: Option<String>, created_at: String, performed_via_github_app: Option<crate::models::NullableIntegration>, milestone: crate::models::MilestonedIssueEventMilestone) -> MilestonedIssueEvent {
