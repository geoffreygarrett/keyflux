...
impl WebhookIssuesUnpinned {
    pub fn new(action: Action, issue: crate::models::WebhooksIssue2, repository: crate::models::RepositoryWebhooks, sender: crate::models::SimpleUserWebhooks) -> WebhookIssuesUnpinned {
