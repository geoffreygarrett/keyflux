...
impl WebhookProjectReopened {
    pub fn new(action: Action, project: crate::models::WebhooksProject, sender: crate::models::SimpleUserWebhooks) -> WebhookProjectReopened {
