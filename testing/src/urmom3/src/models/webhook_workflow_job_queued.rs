...
pub struct WebhookWorkflowJobQueued {
    ...
    pub workflow_job: Box<crate::models::WebhookWorkflowJobQueuedWorkflowJob>,
...
impl WebhookWorkflowJobQueued {
    pub fn new(action: Action, repository: crate::models::RepositoryWebhooks, sender: crate::models::SimpleUserWebhooks, workflow_job: crate::models::WebhookWorkflowJobQueuedWorkflowJob) -> WebhookWorkflowJobQueued {
