...
pub struct Import {
    ...
    #[serde(rename = "failed_step", skip_serializing_if = "Option::is_none")]
    pub failed_step: Option<String>,
    #[serde(rename = "error_message", skip_serializing_if = "Option::is_none")]
    pub error_message: Option<String>,
    #[serde(rename = "import_percent", skip_serializing_if = "Option::is_none")]
    pub import_percent: Option<i32>,
    #[serde(rename = "commit_count", skip_serializing_if = "Option::is_none")]
    pub commit_count: Option<i32>,
    #[serde(rename = "push_percent", skip_serializing_if = "Option::is_none")]
    pub push_percent: Option<i32>,
    ...
    pub project_choices: Option<Vec<crate::models::ImportProjectChoicesInner>>,
    #[serde(rename = "message", skip_serializing_if = "Option::is_none")]
    pub message: Option<String>,
    #[serde(rename = "authors_count", skip_serializing_if = "Option::is_none")]
    pub authors_count: Option<i32>,
    #[serde(rename = "url")]
    pub url: String,
