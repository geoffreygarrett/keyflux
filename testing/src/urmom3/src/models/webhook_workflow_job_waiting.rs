...
pub struct WebhookWorkflowJobWaiting {
    ...
    pub workflow_job: Box<crate::models::WebhookWorkflowJobWaitingWorkflowJob>,
...
impl WebhookWorkflowJobWaiting {
    pub fn new(action: Action, repository: crate::models::RepositoryWebhooks, sender: crate::models::SimpleUserWebhooks, workflow_job: crate::models::WebhookWorkflowJobWaitingWorkflowJob) -> WebhookWorkflowJobWaiting {
