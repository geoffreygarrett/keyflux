...
pub struct WebhookPullRequestAutoMergeEnabled {
    ...
    pub pull_request: Box<crate::models::PullRequest2>,
...
impl WebhookPullRequestAutoMergeEnabled {
    pub fn new(action: Action, number: i32, pull_request: crate::models::PullRequest2, repository: crate::models::RepositoryWebhooks, sender: crate::models::SimpleUserWebhooks) -> WebhookPullRequestAutoMergeEnabled {
