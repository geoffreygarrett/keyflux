...
pub struct WebhookInstallationRepositoriesAdded {
    ...
    pub repositories_removed: Vec<crate::models::WebhookInstallationRepositoriesAddedRepositoriesRemovedInner>,
...
impl WebhookInstallationRepositoriesAdded {
    pub fn new(action: Action, installation: crate::models::Installation, repositories_added: Vec<crate::models::WebhooksRepositoriesInner>, repositories_removed: Vec<crate::models::WebhookInstallationRepositoriesAddedRepositoriesRemovedInner>, repository_selection: crate::models::WebhooksRepositorySelection, requester: Option<crate::models::WebhooksUser>, sender: crate::models::SimpleUserWebhooks) -> WebhookInstallationRepositoriesAdded {
