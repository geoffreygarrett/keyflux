...
pub struct CodeScanningCreateVariantAnalysisRequest {
    ...
    pub language: crate::models::CodeScanningVariantAnalysisLanguage,
...
impl CodeScanningCreateVariantAnalysisRequest {
    pub fn new(language: crate::models::CodeScanningVariantAnalysisLanguage, query_pack: String) -> CodeScanningCreateVariantAnalysisRequest {
