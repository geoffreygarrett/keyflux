...
impl Integration {
    ...
    pub fn new(id: i32, node_id: String, owner: Option<crate::models::NullableSimpleUser>, name: String, description: Option<String>, external_url: String, html_url: String, created_at: String, updated_at: String, permissions: crate::models::IntegrationPermissions, events: Vec<String>) -> Integration {
        Integration {
            id,
            slug: None,
            node_id,
