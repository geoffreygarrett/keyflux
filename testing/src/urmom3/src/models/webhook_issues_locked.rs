...
pub struct WebhookIssuesLocked {
    ...
    #[serde(rename = "issue")]
    pub issue: Box<crate::models::Issue8>,
...
impl WebhookIssuesLocked {
    pub fn new(action: Action, issue: crate::models::Issue8, repository: crate::models::RepositoryWebhooks, sender: crate::models::SimpleUserWebhooks) -> WebhookIssuesLocked {
        WebhookIssuesLocked {
            action,
            enterprise: None,
            installation: None,
