...
pub struct PullRequest8 {
    ...
    pub assignee: Option<Box<crate::models::User7>>,
    #[serde(rename = "assignees")]
    pub assignees: Vec<crate::models::User7>,
    ...
    pub milestone: Option<Box<crate::models::Milestone3>>,
    ...
    pub requested_teams: Vec<crate::models::Team3>,
    ...
    pub url: String,
    #[serde(rename = "user")]
    pub user: Option<Box<crate::models::User8>>,
}

impl PullRequest8 {
    pub fn new(_links: crate::models::PullRequest6Links, active_lock_reason: Option<ActiveLockReason>, assignee: Option<crate::models::User7>, assignees: Vec<crate::models::User7>, author_association: AuthorAssociation, auto_merge: Option<crate::models::PullRequestAutoMerge1>, base: crate::models::PullRequest6Head, body: Option<String>, closed_at: Option<String>, comments_url: String, commits_url: String, created_at: String, diff_url: String, draft: bool, head: crate::models::PullRequest6Head, html_url: String, id: i32, issue_url: String, labels: Vec<crate::models::Label2>, locked: bool, merge_commit_sha: Option<String>, merged_at: Option<String>, milestone: Option<crate::models::Milestone3>, node_id: String, number: i32, patch_url: String, requested_reviewers: Vec<crate::models::OneOfLessThanObjectCommaObjectGreaterThan>, requested_teams: Vec<crate::models::Team3>, review_comment_url: String, review_comments_url: String, state: State, statuses_url: String, title: String, updated_at: String, url: String, user: Option<crate::models::User8>) -> PullRequest8 {
        PullRequest8 {
