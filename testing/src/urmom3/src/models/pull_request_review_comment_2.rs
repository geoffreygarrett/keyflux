...
/// PullRequestReviewComment2 : The [comment](https://docs.github.com/rest/pulls/comments#get-a-review-comment-for-a-pull-request) itself.
...
pub struct PullRequestReviewComment2 {
    #[serde(rename = "_links")]
    pub _links: Box<crate::models::WebhooksReviewCommentLinks>,
