...
pub struct WebhookCheckSuiteCompleted {
    ...
    pub check_suite: Box<crate::models::WebhookCheckSuiteCompletedCheckSuite>,
...
impl WebhookCheckSuiteCompleted {
    pub fn new(action: Action, check_suite: crate::models::WebhookCheckSuiteCompletedCheckSuite, repository: crate::models::RepositoryWebhooks, sender: crate::models::SimpleUserWebhooks) -> WebhookCheckSuiteCompleted {
