...
pub struct WebhookPullRequestSynchronize {
    ...
    pub pull_request: Box<crate::models::PullRequest10>,
...
impl WebhookPullRequestSynchronize {
    pub fn new(action: Action, after: String, before: String, number: i32, pull_request: crate::models::PullRequest10, repository: crate::models::RepositoryWebhooks, sender: crate::models::SimpleUserWebhooks) -> WebhookPullRequestSynchronize {
