...
pub struct Page {
    ...
    #[serde(rename = "protected_domain_state", skip_serializing_if = "Option::is_none")]
    pub protected_domain_state: Option<ProtectedDomainState>,
    /// The timestamp when a pending domain becomes unverified.
    #[serde(rename = "pending_domain_unverified_at", skip_serializing_if = "Option::is_none")]
    ...
    pub source: Option<Box<crate::models::PagesSourceHash>>,
    /// Whether the GitHub Pages site is publicly visible. If set to `true`, the site is accessible to anyone on the internet. If set to `false`, the site will only be accessible to users who have at least `read` access to the repository that published the site.
    #[serde(rename = "public")]
    pub public: bool,
    #[serde(rename = "https_certificate", skip_serializing_if = "Option::is_none")]
    pub https_certificate: Option<Box<crate::models::PagesHttpsCertificate>>,
