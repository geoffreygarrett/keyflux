...
pub struct WebhookPullRequestLabeled {
    ...
    pub pull_request: Box<crate::models::PullRequest4>,
...
impl WebhookPullRequestLabeled {
    pub fn new(action: Action, number: i32, pull_request: crate::models::PullRequest4, repository: crate::models::RepositoryWebhooks, sender: crate::models::SimpleUserWebhooks) -> WebhookPullRequestLabeled {
