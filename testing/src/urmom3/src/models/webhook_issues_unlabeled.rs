...
impl WebhookIssuesUnlabeled {
    pub fn new(action: Action, issue: crate::models::WebhooksIssue, repository: crate::models::RepositoryWebhooks, sender: crate::models::SimpleUserWebhooks) -> WebhookIssuesUnlabeled {
