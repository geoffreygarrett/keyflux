...
pub struct WebhookCheckSuiteRequested {
    ...
    pub check_suite: Box<crate::models::WebhookCheckSuiteRequestedCheckSuite>,
...
impl WebhookCheckSuiteRequested {
    pub fn new(action: Action, check_suite: crate::models::WebhookCheckSuiteRequestedCheckSuite, repository: crate::models::RepositoryWebhooks, sender: crate::models::SimpleUserWebhooks) -> WebhookCheckSuiteRequested {
