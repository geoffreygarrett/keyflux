...
describe 'ReposApi' do
  ...
  # unit tests for repos_cancel_pages_deployment
  # Cancel a GitHub Pages deployment
  # Cancels a GitHub Pages deployment.  The authenticated user must have write permissions for the GitHub Pages site.
  # @param owner The account owner of the repository. The name is not case sensitive.
  # @param repo The name of the repository without the &#x60;.git&#x60; extension. The name is not case sensitive.
  # @param pages_deployment_id The ID of the Pages deployment. You can also give the commit SHA of the deployment.
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'repos_cancel_pages_deployment test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for repos_check_automated_security_fixes
  ...
  describe 'repos_check_automated_security_fixes test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  # unit tests for repos_check_private_vulnerability_reporting
  ...
  describe 'repos_check_private_vulnerability_reporting test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  # unit tests for repos_create_attestation
  ...
  # @param owner The account owner of the repository. The name is not case sensitive.
  # @param repo The name of the repository without the &#x60;.git&#x60; extension. The name is not case sensitive.
  # @param repos_create_attestation_request 
  # @param [Hash] opts the optional parameters
  # @return [ReposCreateAttestation201Response]
  describe 'repos_create_attestation test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  # unit tests for repos_create_deployment_branch_policy
  ...
  # @param deployment_branch_policy_name_pattern_with_type 
  # @param [Hash] opts the optional parameters
  # @return [DeploymentBranchPolicy]
  describe 'repos_create_deployment_branch_policy test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for repos_create_deployment_protection_rule
  ...
  # @param repo The name of the repository without the &#x60;.git&#x60; extension. The name is not case sensitive.
  # @param owner The account owner of the repository. The name is not case sensitive.
  # @param repos_create_deployment_protection_rule_request 
  # @param [Hash] opts the optional parameters
  # @return [DeploymentProtectionRule]
  describe 'repos_create_deployment_protection_rule test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  # unit tests for repos_create_or_update_custom_properties_values
  ...
  # @param owner The account owner of the repository. The name is not case sensitive.
  # @param repo The name of the repository without the &#x60;.git&#x60; extension. The name is not case sensitive.
  # @param repos_create_or_update_custom_properties_values_request 
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'repos_create_or_update_custom_properties_values test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  # unit tests for repos_create_org_ruleset
  # Create an organization repository ruleset
  # Create a repository ruleset for an organization.
  # @param org The organization name. The name is not case sensitive.
  # @param repos_create_org_ruleset_request Request body
  # @param [Hash] opts the optional parameters
  # @return [RepositoryRuleset]
  describe 'repos_create_org_ruleset test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  # unit tests for repos_create_repo_ruleset
  # Create a repository ruleset
  # Create a ruleset for a repository.
  # @param owner The account owner of the repository. The name is not case sensitive.
  # @param repo The name of the repository without the &#x60;.git&#x60; extension. The name is not case sensitive.
  # @param repos_create_repo_ruleset_request Request body
  # @param [Hash] opts the optional parameters
  # @return [RepositoryRuleset]
  describe 'repos_create_repo_ruleset test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  # unit tests for repos_delete_deployment_branch_policy
  ...
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'repos_delete_deployment_branch_policy test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  # unit tests for repos_delete_org_ruleset
  ...
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'repos_delete_org_ruleset test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  # unit tests for repos_delete_repo_ruleset
  ...
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'repos_delete_repo_ruleset test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  # unit tests for repos_disable_deployment_protection_rule
  ...
  # @param repo The name of the repository without the &#x60;.git&#x60; extension. The name is not case sensitive.
  # @param owner The account owner of the repository. The name is not case sensitive.
  # @param protection_rule_id The unique identifier of the protection rule.
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'repos_disable_deployment_protection_rule test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for repos_disable_private_vulnerability_reporting
  ...
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'repos_disable_private_vulnerability_reporting test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  # unit tests for repos_enable_private_vulnerability_reporting
  ...
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'repos_enable_private_vulnerability_reporting test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  # unit tests for repos_get_all_deployment_protection_rules
  ...
  describe 'repos_get_all_deployment_protection_rules test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  # unit tests for repos_get_branch_rules
  ...
  describe 'repos_get_branch_rules test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  # unit tests for repos_get_custom_deployment_protection_rule
  ...
  # @param [Hash] opts the optional parameters
  # @return [DeploymentProtectionRule]
  describe 'repos_get_custom_deployment_protection_rule test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for repos_get_custom_properties_values
  ...
  describe 'repos_get_custom_properties_values test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  # unit tests for repos_get_deployment_branch_policy
  ...
  # @param [Hash] opts the optional parameters
  # @return [DeploymentBranchPolicy]
  describe 'repos_get_deployment_branch_policy test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  # unit tests for repos_get_org_rule_suite
  ...
  # @param org The organization name. The name is not case sensitive.
  # @param rule_suite_id The unique identifier of the rule suite result. To get this ID, you can use [GET /repos/{owner}/{repo}/rulesets/rule-suites](https://docs.github.com/rest/repos/rule-suites#list-repository-rule-suites) for repositories and [GET /orgs/{org}/rulesets/rule-suites](https://docs.github.com/rest/orgs/rule-suites#list-organization-rule-suites) for organizations.
  # @param [Hash] opts the optional parameters
  # @return [RuleSuite]
  describe 'repos_get_org_rule_suite test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for repos_get_org_rule_suites
  ...
  # @option opts [String] :time_period The time period to filter by.  For example, &#x60;day&#x60; will filter for rule suites that occurred in the past 24 hours, and &#x60;week&#x60; will filter for insights that occurred in the past 7 days (168 hours).
  ...
  # @option opts [String] :rule_suite_result The rule results to filter on. When specified, only suites with this result will be returned.
  # @option opts [Integer] :per_page The number of results per page (max 100). For more information, see \&quot;[Using pagination in the REST API](https://docs.github.com/rest/using-the-rest-api/using-pagination-in-the-rest-api).\&quot;
  # @option opts [Integer] :page The page number of the results to fetch. For more information, see \&quot;[Using pagination in the REST API](https://docs.github.com/rest/using-the-rest-api/using-pagination-in-the-rest-api).\&quot;
  # @return [Array<RuleSuitesInner>]
  describe 'repos_get_org_rule_suites test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for repos_get_org_ruleset
  ...
  # @param [Hash] opts the optional parameters
  # @return [RepositoryRuleset]
  describe 'repos_get_org_ruleset test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for repos_get_org_rulesets
  ...
  describe 'repos_get_org_rulesets test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  # unit tests for repos_get_pages_deployment
  ...
  describe 'repos_get_pages_deployment test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  # unit tests for repos_get_repo_rule_suite
  ...
  # @param [Hash] opts the optional parameters
  # @return [RuleSuite]
  describe 'repos_get_repo_rule_suite test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for repos_get_repo_rule_suites
  ...
  # @option opts [Integer] :page The page number of the results to fetch. For more information, see \&quot;[Using pagination in the REST API](https://docs.github.com/rest/using-the-rest-api/using-pagination-in-the-rest-api).\&quot;
  # @return [Array<RuleSuitesInner>]
  describe 'repos_get_repo_rule_suites test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for repos_get_repo_ruleset
  ...
  # @param ruleset_id The ID of the ruleset.
  # @param [Hash] opts the optional parameters
  # @option opts [Boolean] :includes_parents Include rulesets configured at higher levels that apply to this repository
  # @return [RepositoryRuleset]
  describe 'repos_get_repo_ruleset test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for repos_get_repo_rulesets
  ...
  # @option opts [Boolean] :includes_parents Include rulesets configured at higher levels that apply to this repository
  # @return [Array<RepositoryRuleset>]
  describe 'repos_get_repo_rulesets test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  # unit tests for repos_list_activities
  ...
  describe 'repos_list_activities test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for repos_list_attestations
  # List attestations
  ...
  describe 'repos_list_attestations test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  # unit tests for repos_list_custom_deployment_rule_integrations
  ...
  describe 'repos_list_custom_deployment_rule_integrations test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  # unit tests for repos_list_deployment_branch_policies
  ...
  describe 'repos_list_deployment_branch_policies test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  # @param org The organization name. The name is not case sensitive.
  # @param [Hash] opts the optional parameters
  # @option opts [String] :type Specifies the types of repositories you want returned.
  # @option opts [String] :sort The property to sort the results by.
  # @option opts [String] :direction The order to sort by. Default: &#x60;asc&#x60; when using &#x60;full_name&#x60;, otherwise &#x60;desc&#x60;.
  # @option opts [Integer] :per_page The number of results per page (max 100). For more information, see \&quot;[Using pagination in the REST API](https://docs.github.com/rest/using-the-rest-api/using-pagination-in-the-rest-api).\&quot;
  # @option opts [Integer] :page The page number of the results to fetch. For more information, see \&quot;[Using pagination in the REST API](https://docs.github.com/rest/using-the-rest-api/using-pagination-in-the-rest-api).\&quot;
  ...
  # @param repo The name of the repository without the &#x60;.git&#x60; extension. The name is not case sensitive.
  # @param [Hash] opts the optional parameters
  # @option opts [String] :sort The sort order. &#x60;stargazers&#x60; will sort by star count.
  # @option opts [Integer] :per_page The number of results per page (max 100). For more information, see \&quot;[Using pagination in the REST API](https://docs.github.com/rest/using-the-rest-api/using-pagination-in-the-rest-api).\&quot;
  # @option opts [Integer] :page The page number of the results to fetch. For more information, see \&quot;[Using pagination in the REST API](https://docs.github.com/rest/using-the-rest-api/using-pagination-in-the-rest-api).\&quot;
  # @return [Array<MinimalRepository>]
  ...
  # unit tests for repos_update_deployment_branch_policy
  ...
  # @param environment_name The name of the environment. The name must be URL encoded. For example, any slashes in the name must be replaced with &#x60;%2F&#x60;.
  # @param branch_policy_id The unique identifier of the branch policy.
  # @param deployment_branch_policy_name_pattern 
  # @param [Hash] opts the optional parameters
  # @return [DeploymentBranchPolicy]
  describe 'repos_update_deployment_branch_policy test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  # unit tests for repos_update_org_ruleset
  ...
  # @return [RepositoryRuleset]
  describe 'repos_update_org_ruleset test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  # unit tests for repos_update_repo_ruleset
  ...
  # @return [RepositoryRuleset]
  describe 'repos_update_repo_ruleset test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
