...
# Unit tests for OpenapiClient::WebhookStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::WebhookStatus do
  let(:instance) { OpenapiClient::WebhookStatus.new }

  describe 'test an instance of WebhookStatus' do
    it 'should create an instance of WebhookStatus' do
      expect(instance).to be_instance_of(OpenapiClient::WebhookStatus)
    end
  end
  ...
  describe 'test attribute "state"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["pending", "success", "failure", "error"])
