...
# Unit tests for OpenapiClient::App1Permissions
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::App1Permissions do
  let(:instance) { OpenapiClient::App1Permissions.new }

  describe 'test an instance of App1Permissions' do
    it 'should create an instance of App1Permissions' do
      expect(instance).to be_instance_of(OpenapiClient::App1Permissions)
    end
  end
