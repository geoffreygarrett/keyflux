...
# Unit tests for OpenapiClient::App5
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::App5 do
  let(:instance) { OpenapiClient::App5.new }

  describe 'test an instance of App5' do
    it 'should create an instance of App5' do
      expect(instance).to be_instance_of(OpenapiClient::App5)
    end
  end
