...
# Unit tests for OpenapiClient::App15
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::App15 do
  let(:instance) { OpenapiClient::App15.new }

  describe 'test an instance of App15' do
    it 'should create an instance of App15' do
      expect(instance).to be_instance_of(OpenapiClient::App15)
    end
  end
