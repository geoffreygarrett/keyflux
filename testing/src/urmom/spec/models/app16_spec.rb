...
# Unit tests for OpenapiClient::App16
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::App16 do
  let(:instance) { OpenapiClient::App16.new }

  describe 'test an instance of App16' do
    it 'should create an instance of App16' do
      expect(instance).to be_instance_of(OpenapiClient::App16)
    end
  end
