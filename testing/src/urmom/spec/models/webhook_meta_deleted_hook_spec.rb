...
# Unit tests for OpenapiClient::WebhookMetaDeletedHook
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::WebhookMetaDeletedHook do
  let(:instance) { OpenapiClient::WebhookMetaDeletedHook.new }

  describe 'test an instance of WebhookMetaDeletedHook' do
    it 'should create an instance of WebhookMetaDeletedHook' do
      expect(instance).to be_instance_of(OpenapiClient::WebhookMetaDeletedHook)
    end
  end
