...
# Unit tests for OpenapiClient::App11
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::App11 do
  let(:instance) { OpenapiClient::App11.new }

  describe 'test an instance of App11' do
    it 'should create an instance of App11' do
      expect(instance).to be_instance_of(OpenapiClient::App11)
    end
  end
