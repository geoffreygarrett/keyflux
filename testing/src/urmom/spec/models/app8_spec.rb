...
# Unit tests for OpenapiClient::App8
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::App8 do
  let(:instance) { OpenapiClient::App8.new }

  describe 'test an instance of App8' do
    it 'should create an instance of App8' do
      expect(instance).to be_instance_of(OpenapiClient::App8)
    end
  end
