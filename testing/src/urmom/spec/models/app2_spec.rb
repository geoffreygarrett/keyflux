...
# Unit tests for OpenapiClient::App2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::App2 do
  let(:instance) { OpenapiClient::App2.new }

  describe 'test an instance of App2' do
    it 'should create an instance of App2' do
      expect(instance).to be_instance_of(OpenapiClient::App2)
    end
  end
