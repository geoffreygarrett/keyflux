...
# Unit tests for OpenapiClient::App2Permissions
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::App2Permissions do
  let(:instance) { OpenapiClient::App2Permissions.new }

  describe 'test an instance of App2Permissions' do
    it 'should create an instance of App2Permissions' do
      expect(instance).to be_instance_of(OpenapiClient::App2Permissions)
    end
  end
