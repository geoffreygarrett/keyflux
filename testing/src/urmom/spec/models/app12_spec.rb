...
# Unit tests for OpenapiClient::App12
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::App12 do
  let(:instance) { OpenapiClient::App12.new }

  describe 'test an instance of App12' do
    it 'should create an instance of App12' do
      expect(instance).to be_instance_of(OpenapiClient::App12)
    end
  end
