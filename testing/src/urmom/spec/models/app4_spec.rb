...
# Unit tests for OpenapiClient::App4
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::App4 do
  let(:instance) { OpenapiClient::App4.new }

  describe 'test an instance of App4' do
    it 'should create an instance of App4' do
      expect(instance).to be_instance_of(OpenapiClient::App4)
    end
  end
