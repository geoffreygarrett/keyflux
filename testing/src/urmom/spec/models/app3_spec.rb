...
# Unit tests for OpenapiClient::App3
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::App3 do
  let(:instance) { OpenapiClient::App3.new }

  describe 'test an instance of App3' do
    it 'should create an instance of App3' do
      expect(instance).to be_instance_of(OpenapiClient::App3)
    end
  end
