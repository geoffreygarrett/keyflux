...
# Unit tests for OpenapiClient::App9
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::App9 do
  let(:instance) { OpenapiClient::App9.new }

  describe 'test an instance of App9' do
    it 'should create an instance of App9' do
      expect(instance).to be_instance_of(OpenapiClient::App9)
    end
  end
