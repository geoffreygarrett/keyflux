...
# Unit tests for OpenapiClient::App13
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::App13 do
  let(:instance) { OpenapiClient::App13.new }

  describe 'test an instance of App13' do
    it 'should create an instance of App13' do
      expect(instance).to be_instance_of(OpenapiClient::App13)
    end
  end
