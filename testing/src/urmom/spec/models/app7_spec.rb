...
# Unit tests for OpenapiClient::App7
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::App7 do
  let(:instance) { OpenapiClient::App7.new }

  describe 'test an instance of App7' do
    it 'should create an instance of App7' do
      expect(instance).to be_instance_of(OpenapiClient::App7)
    end
  end
