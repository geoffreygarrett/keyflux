...
# Unit tests for OpenapiClient::App6
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::App6 do
  let(:instance) { OpenapiClient::App6.new }

  describe 'test an instance of App6' do
    it 'should create an instance of App6' do
      expect(instance).to be_instance_of(OpenapiClient::App6)
    end
  end
