...
# Unit tests for OpenapiClient::App10
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::App10 do
  let(:instance) { OpenapiClient::App10.new }

  describe 'test an instance of App10' do
    it 'should create an instance of App10' do
      expect(instance).to be_instance_of(OpenapiClient::App10)
    end
  end
