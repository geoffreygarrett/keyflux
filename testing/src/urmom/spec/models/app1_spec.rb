...
# Unit tests for OpenapiClient::App1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::App1 do
  let(:instance) { OpenapiClient::App1.new }

  describe 'test an instance of App1' do
    it 'should create an instance of App1' do
      expect(instance).to be_instance_of(OpenapiClient::App1)
    end
  end
