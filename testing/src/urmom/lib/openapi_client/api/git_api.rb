...
module OpenapiClient
  class GitApi
    ...
    # @param git_create_ref_request [GitCreateRefRequest] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(GitRef, Integer, Hash)>] GitRef data, response status code and response headers
    def git_create_ref_with_http_info(owner, repo, git_create_ref_request, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GitRef'
    ...
    # @param owner [String] The account owner of the repository. The name is not case sensitive.
    # @param repo [String] The name of the repository without the &#x60;.git&#x60; extension. The name is not case sensitive.
    # @param ref [String] The Git reference. For more information, see \&quot;[Git References](https://git-scm.com/book/en/v2/Git-Internals-Git-References)\&quot; in the Git documentation.
    # @param [Hash] opts the optional parameters
    # @return [nil]
    ...
    # @param ref [String] The Git reference. For more information, see \&quot;[Git References](https://git-scm.com/book/en/v2/Git-Internals-Git-References)\&quot; in the Git documentation.
    # @param [Hash] opts the optional parameters
    # @return [Array<(Array<GitRef>, Integer, Hash)>] Array<GitRef> data, response status code and response headers
    def git_list_matching_refs_with_http_info(owner, repo, ref, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'Array<GitRef>'
