...
module OpenapiClient
  class InteractionsApi
    ...
    # @param interaction_limit [InteractionLimit] 
    # @param [Hash] opts the optional parameters
    # @return [InteractionLimitResponse]
    def interactions_set_restrictions_for_authenticated_user(interaction_limit, opts = {})
      data, _status_code, _headers = interactions_set_restrictions_for_authenticated_user_with_http_info(interaction_limit, opts)
      data
    end
    ...
    # @param interaction_limit [InteractionLimit] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(InteractionLimitResponse, Integer, Hash)>] InteractionLimitResponse data, response status code and response headers
    def interactions_set_restrictions_for_authenticated_user_with_http_info(interaction_limit, opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && interaction_limit.nil?
        fail ArgumentError, "Missing the required parameter 'interaction_limit' when calling InteractionsApi.interactions_set_restrictions_for_authenticated_user"
      end
      # resource path
      local_var_path = '/user/interaction-limits'
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(interaction_limit)

      # return_type
      return_type = opts[:debug_return_type] || 'InteractionLimitResponse'
    ...
    # @param [Hash] opts the optional parameters
    # @return [InteractionLimitResponse]
    def interactions_set_restrictions_for_org(org, interaction_limit, opts = {})
      data, _status_code, _headers = interactions_set_restrictions_for_org_with_http_info(org, interaction_limit, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(InteractionLimitResponse, Integer, Hash)>] InteractionLimitResponse data, response status code and response headers
    def interactions_set_restrictions_for_org_with_http_info(org, interaction_limit, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'interaction_limit' is set
      if @api_client.config.client_side_validation && interaction_limit.nil?
        fail ArgumentError, "Missing the required parameter 'interaction_limit' when calling InteractionsApi.interactions_set_restrictions_for_org"
      end
      # resource path
      local_var_path = '/orgs/{org}/interaction-limits'.sub('{' + 'org' + '}', CGI.escape(org.to_s))
    ...
    # @param [Hash] opts the optional parameters
    # @return [InteractionLimitResponse]
    def interactions_set_restrictions_for_repo(owner, repo, interaction_limit, opts = {})
      data, _status_code, _headers = interactions_set_restrictions_for_repo_with_http_info(owner, repo, interaction_limit, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(InteractionLimitResponse, Integer, Hash)>] InteractionLimitResponse data, response status code and response headers
    def interactions_set_restrictions_for_repo_with_http_info(owner, repo, interaction_limit, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'interaction_limit' is set
      if @api_client.config.client_side_validation && interaction_limit.nil?
        fail ArgumentError, "Missing the required parameter 'interaction_limit' when calling InteractionsApi.interactions_set_restrictions_for_repo"
      end
      # resource path
      local_var_path = '/repos/{owner}/{repo}/interaction-limits'.sub('{' + 'owner' + '}', CGI.escape(owner.to_s)).sub('{' + 'repo' + '}', CGI.escape(repo.to_s))
