...
module OpenapiClient
  class PullsApi
    ...
    # @option opts [String] :sort What to sort results by. &#x60;popularity&#x60; will sort by the number of comments. &#x60;long-running&#x60; will sort by date created and will limit the results to pull requests that have been open for more than a month and have had activity within the past month. (default to 'created')
    ...
    # @option opts [Integer] :per_page The number of results per page (max 100). For more information, see \&quot;[Using pagination in the REST API](https://docs.github.com/rest/using-the-rest-api/using-pagination-in-the-rest-api).\&quot; (default to 30)
    # @option opts [Integer] :page The page number of the results to fetch. For more information, see \&quot;[Using pagination in the REST API](https://docs.github.com/rest/using-the-rest-api/using-pagination-in-the-rest-api).\&quot; (default to 1)
    # @return [Array<(Array<ReviewComment>, Integer, Hash)>] Array<ReviewComment> data, response status code and response headers
    def pulls_list_comments_for_review_with_http_info(owner, repo, pull_number, review_id, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'Array<ReviewComment>'
