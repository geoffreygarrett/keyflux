...
module OpenapiClient
  class ActivityApi
    ...
    # @param repo [String] The name of the repository without the &#x60;.git&#x60; extension. The name is not case sensitive.
    # @param [Hash] opts the optional parameters
    # @return [Array<(RepositorySubscription, Integer, Hash)>] RepositorySubscription data, response status code and response headers
    def activity_get_repo_subscription_with_http_info(owner, repo, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'RepositorySubscription'
    ...
    # @option opts [Integer] :page The page number of the results to fetch. For more information, see \&quot;[Using pagination in the REST API](https://docs.github.com/rest/using-the-rest-api/using-pagination-in-the-rest-api).\&quot; (default to 1)
    # @option opts [Integer] :per_page The number of results per page (max 50). For more information, see \&quot;[Using pagination in the REST API](https://docs.github.com/rest/using-the-rest-api/using-pagination-in-the-rest-api).\&quot; (default to 50)
    # @return [Array<Thread>]
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def activity_mark_thread_as_done(thread_id, opts = {})
      activity_mark_thread_as_done_with_http_info(thread_id, opts)
      nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def activity_mark_thread_as_done_with_http_info(thread_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ActivityApi.activity_mark_thread_as_done ...'
      end
      # verify the required parameter 'thread_id' is set
      if @api_client.config.client_side_validation && thread_id.nil?
        fail ArgumentError, "Missing the required parameter 'thread_id' when calling ActivityApi.activity_mark_thread_as_done"
      end
      # resource path
      local_var_path = '/notifications/threads/{thread_id}'.sub('{' + 'thread_id' + '}', CGI.escape(thread_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"ActivityApi.activity_mark_thread_as_done",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ActivityApi#activity_mark_thread_as_done\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
