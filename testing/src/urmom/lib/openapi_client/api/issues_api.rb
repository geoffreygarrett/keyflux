...
module OpenapiClient
  class IssuesApi
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def issues_check_user_can_be_assigned_to_issue(owner, repo, issue_number, assignee, opts = {})
      issues_check_user_can_be_assigned_to_issue_with_http_info(owner, repo, issue_number, assignee, opts)
      nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def issues_check_user_can_be_assigned_to_issue_with_http_info(owner, repo, issue_number, assignee, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: IssuesApi.issues_check_user_can_be_assigned_to_issue ...'
      end
      # verify the required parameter 'owner' is set
      if @api_client.config.client_side_validation && owner.nil?
        fail ArgumentError, "Missing the required parameter 'owner' when calling IssuesApi.issues_check_user_can_be_assigned_to_issue"
      end
      # verify the required parameter 'repo' is set
      if @api_client.config.client_side_validation && repo.nil?
        fail ArgumentError, "Missing the required parameter 'repo' when calling IssuesApi.issues_check_user_can_be_assigned_to_issue"
      end
      # verify the required parameter 'issue_number' is set
      if @api_client.config.client_side_validation && issue_number.nil?
        fail ArgumentError, "Missing the required parameter 'issue_number' when calling IssuesApi.issues_check_user_can_be_assigned_to_issue"
      end
      # verify the required parameter 'assignee' is set
      if @api_client.config.client_side_validation && assignee.nil?
        fail ArgumentError, "Missing the required parameter 'assignee' when calling IssuesApi.issues_check_user_can_be_assigned_to_issue"
      end
      # resource path
      local_var_path = '/repos/{owner}/{repo}/issues/{issue_number}/assignees/{assignee}'.sub('{' + 'owner' + '}', CGI.escape(owner.to_s)).sub('{' + 'repo' + '}', CGI.escape(repo.to_s)).sub('{' + 'issue_number' + '}', CGI.escape(issue_number.to_s)).sub('{' + 'assignee' + '}', CGI.escape(assignee.to_s))
      ...
      new_options = opts.merge(
        :operation => :"IssuesApi.issues_check_user_can_be_assigned_to_issue",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: IssuesApi#issues_check_user_can_be_assigned_to_issue\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :state Indicates the state of the issues to return. (default to 'open')
    # @option opts [String] :labels A list of comma separated label names. Example: &#x60;bug,ui,@high&#x60;
    # @option opts [String] :sort What to sort results by. (default to 'created')
    ...
    # @option opts [Integer] :per_page The number of results per page (max 100). For more information, see \&quot;[Using pagination in the REST API](https://docs.github.com/rest/using-the-rest-api/using-pagination-in-the-rest-api).\&quot; (default to 30)
    # @option opts [Integer] :page The page number of the results to fetch. For more information, see \&quot;[Using pagination in the REST API](https://docs.github.com/rest/using-the-rest-api/using-pagination-in-the-rest-api).\&quot; (default to 1)
    # @return [Array<(Array<TimelineIssueEvents>, Integer, Hash)>] Array<TimelineIssueEvents> data, response status code and response headers
    def issues_list_events_for_timeline_with_http_info(owner, repo, issue_number, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'Array<TimelineIssueEvents>'
