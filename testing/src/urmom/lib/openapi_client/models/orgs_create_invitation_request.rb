...
module OpenapiClient
  class OrgsCreateInvitationRequest
    ...
    def valid?
      role_validator = EnumAttributeValidator.new('String', ["admin", "direct_member", "billing_manager", "reinstate"])
    ...
    def role=(role)
      validator = EnumAttributeValidator.new('String', ["admin", "direct_member", "billing_manager", "reinstate"])
