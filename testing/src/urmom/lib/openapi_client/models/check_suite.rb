...
module OpenapiClient
  ...
  class CheckSuite
    ...
    def valid?
      ...
      conclusion_validator = EnumAttributeValidator.new('String', ["success", "failure", "neutral", "cancelled", "skipped", "timed_out", "action_required", "startup_failure", "stale", "null"])
    ...
    def conclusion=(conclusion)
      validator = EnumAttributeValidator.new('String', ["success", "failure", "neutral", "cancelled", "skipped", "timed_out", "action_required", "startup_failure", "stale", "null"])
