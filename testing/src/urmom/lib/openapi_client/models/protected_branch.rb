...
module OpenapiClient
  ...
  class ProtectedBranch
    ...
    def hash
      [url, required_status_checks, required_pull_request_reviews, required_signatures, enforce_admins, required_linear_history, allow_force_pushes, allow_deletions, restrictions, required_conversation_resolution, block_creations, lock_branch, allow_fork_syncing].hash
    end
