...
module OpenapiClient
  class PullRequest8
    ...
    def self.openapi_types
      {
        :'_links' => :'PullRequest6Links',
        :'active_lock_reason' => :'String',
        :'additions' => :'Integer',
        :'assignee' => :'User7',
        :'assignees' => :'Array<User7>',
        :'author_association' => :'String',
        :'auto_merge' => :'PullRequestAutoMerge1',
        :'base' => :'PullRequest6Head',
        :'body' => :'String',
        ...
        :'patch_url' => :'String',
        :'rebaseable' => :'Boolean',
        :'requested_reviewers' => :'Array<OneOfobjectobject>',
        :'requested_teams' => :'Array<Team3>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::PullRequest8` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::PullRequest8`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
