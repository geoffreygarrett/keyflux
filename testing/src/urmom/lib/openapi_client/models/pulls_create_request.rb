...
module OpenapiClient
  class PullsCreateRequest
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'head_repo')
        self.head_repo = attributes[:'head_repo']
      end
    ...
    def hash
      [title, head, head_repo, base, body, maintainer_can_modify, draft, issue].hash
    end
