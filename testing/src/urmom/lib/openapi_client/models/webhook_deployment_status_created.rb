...
module OpenapiClient
  class WebhookDeploymentStatusCreated
    ...
    def self.openapi_types
      {
        :'action' => :'String',
        :'check_run' => :'WebhookDeploymentStatusCreatedCheckRun',
        ...
        :'workflow_run' => :'DeploymentWorkflowRun4'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::WebhookDeploymentStatusCreated` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::WebhookDeploymentStatusCreated`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'check_run')
        self.check_run = attributes[:'check_run']
      end
    ...
    def list_invalid_properties
      ...
      if @deployment_status.nil?
        invalid_properties.push('invalid value for "deployment_status", deployment_status cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @deployment_status.nil?
    ...
    def hash
      [action, check_run, deployment, deployment_status, enterprise, installation, organization, repository, sender, workflow, workflow_run].hash
    end
