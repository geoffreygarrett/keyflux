...
module OpenapiClient
  class RateLimitOverviewResources
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'code_search')
        self.code_search = attributes[:'code_search']
      end
    ...
    def hash
      [core, graphql, search, code_search, source_import, integration_manifest, code_scanning_upload, actions_runner_registration, scim, dependency_snapshots].hash
    end
