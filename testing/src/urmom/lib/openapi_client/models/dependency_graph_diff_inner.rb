...
module OpenapiClient
  class DependencyGraphDiffInner
    ...
    def valid?
      ...
      scope_validator = EnumAttributeValidator.new('String', ["unknown", "runtime", "development"])
    ...
    def scope=(scope)
      validator = EnumAttributeValidator.new('String', ["unknown", "runtime", "development"])
    ...
    def hash
      [change_type, manifest, ecosystem, name, version, package_url, license, source_repository_url, vulnerabilities, scope].hash
    end
