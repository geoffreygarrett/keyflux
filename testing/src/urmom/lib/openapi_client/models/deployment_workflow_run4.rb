  ...
  class DeploymentWorkflowRun4
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::DeploymentWorkflowRun4` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::DeploymentWorkflowRun4`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @display_title.nil?
        invalid_properties.push('invalid value for "display_title", display_title cannot be nil.')
      end
      ...
      if @head_branch.nil?
        invalid_properties.push('invalid value for "head_branch", head_branch cannot be nil.')
      end
    ...
    def valid?
      ...
      conclusion_validator = EnumAttributeValidator.new('String', ["success", "failure", "neutral", "cancelled", "timed_out", "action_required", "stale", "null", "startup_failure"])
      return false unless conclusion_validator.valid?(@conclusion)
      return false if @created_at.nil?
      return false if @display_title.nil?
      return false if @event.nil?
      return false if @head_branch.nil?
      ...
      status_validator = EnumAttributeValidator.new('String', ["requested", "in_progress", "completed", "queued", "waiting", "pending"])
    ...
    def conclusion=(conclusion)
      validator = EnumAttributeValidator.new('String', ["success", "failure", "neutral", "cancelled", "timed_out", "action_required", "stale", "null", "startup_failure"])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ["requested", "in_progress", "completed", "queued", "waiting", "pending"])
