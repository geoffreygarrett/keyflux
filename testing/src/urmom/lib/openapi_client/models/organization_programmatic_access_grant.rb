...
module OpenapiClient
  ...
  class OrganizationProgrammaticAccessGrant
    ...
    attr_accessor :access_granted_at
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::OrganizationProgrammaticAccessGrant` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::OrganizationProgrammaticAccessGrant`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'access_granted_at')
        self.access_granted_at = attributes[:'access_granted_at']
      end
    ...
    def list_invalid_properties
      ...
      if @access_granted_at.nil?
        invalid_properties.push('invalid value for "access_granted_at", access_granted_at cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @access_granted_at.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          access_granted_at == o.access_granted_at &&
    ...
    def hash
      [id, owner, repository_selection, repositories_url, permissions, access_granted_at, token_expired, token_expires_at, token_last_used_at].hash
    end
