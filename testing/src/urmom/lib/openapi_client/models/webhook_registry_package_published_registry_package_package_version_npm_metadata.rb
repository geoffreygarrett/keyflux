  ...
  class WebhookRegistryPackagePublishedRegistryPackagePackageVersionNpmMetadata
    ...
    def self.openapi_types
      {
        ...
        :'version' => :'String',
        :'npm_user' => :'String',
        :'author' => :'Deployment1Payload',
        :'bugs' => :'Deployment1Payload',
        :'dependencies' => :'Object',
        :'dev_dependencies' => :'Object',
        :'peer_dependencies' => :'Object',
        :'optional_dependencies' => :'Object',
        :'description' => :'String',
        :'dist' => :'Deployment1Payload',
        :'git_head' => :'String',
        :'homepage' => :'String',
        :'license' => :'String',
        :'main' => :'String',
        :'repository' => :'Deployment1Payload',
        :'scripts' => :'Object',
        :'id' => :'String',
        :'node_version' => :'String',
        :'npm_version' => :'String',
        ...
        :'bin' => :'Object',
        :'man' => :'Object',
        :'directories' => :'Deployment1Payload',
        :'os' => :'Array<String>',
        :'cpu' => :'Array<String>',
        :'readme' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::WebhookRegistryPackagePublishedRegistryPackagePackageVersionNpmMetadata` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::WebhookRegistryPackagePublishedRegistryPackagePackageVersionNpmMetadata`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
