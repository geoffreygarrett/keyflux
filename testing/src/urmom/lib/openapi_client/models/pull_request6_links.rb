  ...
  class PullRequest6Links
    ...
    def self.openapi_types
      {
        ...
        :'html' => :'Link1',
        :'issue' => :'Link1',
        :'review_comment' => :'Link1',
        :'review_comments' => :'Link1',
        :'_self' => :'Link1',
        :'statuses' => :'Link1'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::PullRequest6Links` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::PullRequest6Links`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [comments, commits, html, issue, review_comment, review_comments, _self, statuses].hash
    end
