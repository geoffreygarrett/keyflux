...
module OpenapiClient
  ...
  class Deployment1
    ...
    def self.openapi_types
      {
        ...
        :'payload' => :'Deployment1Payload',
        :'performed_via_github_app' => :'App6',
    ...
    def list_invalid_properties
      ...
      if @original_environment.nil?
        invalid_properties.push('invalid value for "original_environment", original_environment cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @original_environment.nil?
    ...
    def hash
      [created_at, creator, description, environment, id, node_id, original_environment, payload, performed_via_github_app, production_environment, ref, repository_url, sha, statuses_url, task, transient_environment, updated_at, url].hash
    end
