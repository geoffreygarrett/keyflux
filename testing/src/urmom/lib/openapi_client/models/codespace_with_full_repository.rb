...
module OpenapiClient
  ...
  class CodespaceWithFullRepository
    ...
    attr_accessor :retention_expires_at
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::CodespaceWithFullRepository` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::CodespaceWithFullRepository`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'retention_expires_at')
        self.retention_expires_at = attributes[:'retention_expires_at']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          retention_expires_at == o.retention_expires_at
    end
