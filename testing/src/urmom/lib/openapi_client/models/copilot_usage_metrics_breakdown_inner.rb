  ...
  class CopilotUsageMetricsBreakdownInner
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::CopilotUsageMetricsBreakdownInner` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::CopilotUsageMetricsBreakdownInner`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'suggestions_count')
        self.suggestions_count = attributes[:'suggestions_count']
      end

      if attributes.key?(:'acceptances_count')
        self.acceptances_count = attributes[:'acceptances_count']
      end

      if attributes.key?(:'lines_suggested')
        self.lines_suggested = attributes[:'lines_suggested']
      end

      if attributes.key?(:'lines_accepted')
        self.lines_accepted = attributes[:'lines_accepted']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          language == o.language &&
          editor == o.editor &&
          suggestions_count == o.suggestions_count &&
          acceptances_count == o.acceptances_count &&
          lines_suggested == o.lines_suggested &&
          lines_accepted == o.lines_accepted &&
    ...
    def hash
      [language, editor, suggestions_count, acceptances_count, lines_suggested, lines_accepted, active_users].hash
    end
