...
module OpenapiClient
  class RepositoryAdvisoryCreate
    ...
    attr_accessor :start_private_fork
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::RepositoryAdvisoryCreate` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::RepositoryAdvisoryCreate`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'start_private_fork')
        self.start_private_fork = attributes[:'start_private_fork']
      else
        self.start_private_fork = false
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          start_private_fork == o.start_private_fork
    end
    ...
    def hash
      [summary, description, cve_id, vulnerabilities, cwe_ids, credits, severity, cvss_vector_string, start_private_fork].hash
    end
