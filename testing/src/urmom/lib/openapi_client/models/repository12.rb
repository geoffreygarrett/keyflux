  ...
  class Repository12
    ...
    def self.openapi_types
      {
        ...
        :'created_at' => :'OneOfintegerDateTime',
        ...
        :'organization' => :'String',
        :'owner' => :'User5',
        :'permissions' => :'Repository11Permissions',
        :'private' => :'Boolean',
        :'public' => :'Boolean',
        :'pulls_url' => :'String',
        :'pushed_at' => :'OneOfintegerDateTime',
        :'releases_url' => :'String',
        :'role_name' => :'String',
        :'size' => :'Integer',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::Repository12` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::Repository12`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @has_discussions.nil?
        invalid_properties.push('invalid value for "has_discussions", has_discussions cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @has_discussions.nil?
