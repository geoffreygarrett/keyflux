...
module OpenapiClient
  class PendingDeploymentReviewersInnerReviewer
    ...
    def hash
      [name, email, login, id, node_id, avatar_url, gravatar_id, url, html_url, followers_url, following_url, gists_url, starred_url, subscriptions_url, organizations_url, repos_url, events_url, received_events_url, type, site_admin, starred_at, slug, description, privacy, notification_setting, permission, permissions, members_url, repositories_url, parent].hash
    end
