...
module OpenapiClient
  ...
  class Release
    ...
    def valid?
      ...
      prerelease_validator = EnumAttributeValidator.new('Boolean', ["true"])
      return false unless prerelease_validator.valid?(@prerelease)
    ...
    # @param [Object] prerelease Object to be assigned
    def prerelease=(prerelease)
      validator = EnumAttributeValidator.new('Boolean', ["true"])
      unless validator.valid?(prerelease)
        fail ArgumentError, "invalid value for \"prerelease\", must be one of #{validator.allowable_values}."
      end
      @prerelease = prerelease
    end
