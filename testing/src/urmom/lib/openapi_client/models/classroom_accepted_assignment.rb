  ...
  class ClassroomAcceptedAssignment
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::ClassroomAcceptedAssignment` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::ClassroomAcceptedAssignment`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @commit_count.nil?
        invalid_properties.push('invalid value for "commit_count", commit_count cannot be nil.')
      end

      if @grade.nil?
        invalid_properties.push('invalid value for "grade", grade cannot be nil.')
      end

      if @students.nil?
        invalid_properties.push('invalid value for "students", students cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @commit_count.nil?
    ...
    def hash
      [id, submitted, passing, commit_count, grade, students, repository, assignment].hash
    end
