  ...
  class WebhooksTeamParent
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::WebhooksTeamParent` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::WebhooksTeamParent`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'notification_setting')
        self.notification_setting = attributes[:'notification_setting']
      end
    ...
    def list_invalid_properties
      ...
      if @notification_setting.nil?
        invalid_properties.push('invalid value for "notification_setting", notification_setting cannot be nil.')
      end
    ...
    def valid?
      ...
      privacy_validator = EnumAttributeValidator.new('String', ["open", "closed", "secret"])
      return false unless privacy_validator.valid?(@privacy)
      return false if @notification_setting.nil?
      notification_setting_validator = EnumAttributeValidator.new('String', ["notifications_enabled", "notifications_disabled"])
      return false unless notification_setting_validator.valid?(@notification_setting)
    ...
    def privacy=(privacy)
      validator = EnumAttributeValidator.new('String', ["open", "closed", "secret"])
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] notification_setting Object to be assigned
    def notification_setting=(notification_setting)
      validator = EnumAttributeValidator.new('String', ["notifications_enabled", "notifications_disabled"])
      unless validator.valid?(notification_setting)
        fail ArgumentError, "invalid value for \"notification_setting\", must be one of #{validator.allowable_values}."
      end
      @notification_setting = notification_setting
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          privacy == o.privacy &&
          notification_setting == o.notification_setting &&
    ...
    def hash
      [description, html_url, id, members_url, name, node_id, permission, privacy, notification_setting, repositories_url, slug, url].hash
    end
