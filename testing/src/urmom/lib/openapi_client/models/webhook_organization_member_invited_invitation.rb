...
module OpenapiClient
  ...
  class WebhookOrganizationMemberInvitedInvitation
    ...
    attr_accessor :invitation_source
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::WebhookOrganizationMemberInvitedInvitation` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::WebhookOrganizationMemberInvitedInvitation`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'invitation_source')
        self.invitation_source = attributes[:'invitation_source']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          invitation_source == o.invitation_source
    end
    ...
    def hash
      [created_at, email, failed_at, failed_reason, id, invitation_teams_url, inviter, login, node_id, role, team_count, invitation_source].hash
    end
