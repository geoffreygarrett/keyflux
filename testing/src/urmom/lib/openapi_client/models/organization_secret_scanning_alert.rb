...
module OpenapiClient
  class OrganizationSecretScanningAlert
    ...
    attr_accessor :resolution_comment
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::OrganizationSecretScanningAlert` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::OrganizationSecretScanningAlert`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'resolution_comment')
        self.resolution_comment = attributes[:'resolution_comment']
      end
    ...
    def valid?
      validity_validator = EnumAttributeValidator.new('String', ["active", "inactive", "unknown"])
    ...
    def validity=(validity)
      validator = EnumAttributeValidator.new('String', ["active", "inactive", "unknown"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          resolution_comment == o.resolution_comment &&
          validity == o.validity
    end
    ...
    def hash
      [number, created_at, updated_at, url, html_url, locations_url, state, resolution, resolved_at, resolved_by, secret_type, secret_type_display_name, secret, repository, push_protection_bypassed, push_protection_bypassed_by, push_protection_bypassed_at, resolution_comment, validity].hash
    end
