...
module OpenapiClient
  ...
  class Codespace
    ...
    attr_accessor :last_known_stop_notice
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'last_known_stop_notice')
        self.last_known_stop_notice = attributes[:'last_known_stop_notice']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          last_known_stop_notice == o.last_known_stop_notice
    end
